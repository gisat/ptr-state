...
var reduxBatch = require('@manaflair/redux-batch');
...
var _map2__default = /*#__PURE__*/_interopDefaultLegacy(_map2);
var _flatMap__default = /*#__PURE__*/_interopDefaultLegacy(_flatMap);
var _find2__default = /*#__PURE__*/_interopDefaultLegacy(_find2);
var _remove__default = /*#__PURE__*/_interopDefaultLegacy(_remove);
var _isObject2__default = /*#__PURE__*/_interopDefaultLegacy(_isObject2);
var _forIn2__default = /*#__PURE__*/_interopDefaultLegacy(_forIn2);
var _chunk__default = /*#__PURE__*/_interopDefaultLegacy(_chunk);
var _each__default = /*#__PURE__*/_interopDefaultLegacy(_each);
var _isEmpty2__default = /*#__PURE__*/_interopDefaultLegacy(_isEmpty2);
var _isArray2__default = /*#__PURE__*/_interopDefaultLegacy(_isArray2);
var _isEqual2__default = /*#__PURE__*/_interopDefaultLegacy(_isEqual2);
var moment__default = /*#__PURE__*/_interopDefaultLegacy(moment);
var _tail2__default = /*#__PURE__*/_interopDefaultLegacy(_tail2);
var _sortBy2__default = /*#__PURE__*/_interopDefaultLegacy(_sortBy2);
var _reduce2__default = /*#__PURE__*/_interopDefaultLegacy(_reduce2);
var _isNumber2__default = /*#__PURE__*/_interopDefaultLegacy(_isNumber2);
var _head2__default = /*#__PURE__*/_interopDefaultLegacy(_head2);
var createCachedSelector__default = /*#__PURE__*/_interopDefaultLegacy(createCachedSelector);
var _pickBy2__default = /*#__PURE__*/_interopDefaultLegacy(_pickBy2);
var _pick2__default = /*#__PURE__*/_interopDefaultLegacy(_pick2);
var _difference2__default = /*#__PURE__*/_interopDefaultLegacy(_difference2);
var _forEach2__default = /*#__PURE__*/_interopDefaultLegacy(_forEach2);
...
var _isMatch2__default = /*#__PURE__*/_interopDefaultLegacy(_isMatch2);
var _isFinite2__default = /*#__PURE__*/_interopDefaultLegacy(_isFinite2);
var _flatten2__default = /*#__PURE__*/_interopDefaultLegacy(_flatten2);
var _compact2__default = /*#__PURE__*/_interopDefaultLegacy(_compact2);
var _omitBy__default = /*#__PURE__*/_interopDefaultLegacy(_omitBy);
var _intersection2__default = /*#__PURE__*/_interopDefaultLegacy(_intersection2);
var _flattenDeep2__default = /*#__PURE__*/_interopDefaultLegacy(_flattenDeep2);
var _merge2__default = /*#__PURE__*/_interopDefaultLegacy(_merge2);
var _values__default = /*#__PURE__*/_interopDefaultLegacy(_values);
var React__default = /*#__PURE__*/_interopDefaultLegacy(React);
var _union2__default = /*#__PURE__*/_interopDefaultLegacy(_union2);
var _omit2__default = /*#__PURE__*/_interopDefaultLegacy(_omit2);
var _findIndex2__default = /*#__PURE__*/_interopDefaultLegacy(_findIndex2);
var _indexOf2__default = /*#__PURE__*/_interopDefaultLegacy(_indexOf2);
...
var commonActionTypes = ptrUtils.utils.deepKeyMirror({
  APP: {
    SET_KEY: null,
    SET_BASE_URL: null,
...
var fetch = _fetch__default['default'];
/**
...
function request(localConfig, apiPath, method, query, payload, ttl, dataPath) {
  ...
  if (_isUndefined__default['default'](dataPath)) dataPath = DATAPATH;
  ...
  return fetch(url, {
    ...
    if (response.ok && contentType && contentType.indexOf('application/json') !== -1) {
      return response.json().then(function (body) {
        if (dataPath === null || dataPath && _get__default['default'](body, dataPath)) {
          return body;
        } else {
...
var getCompleteLocalConfigurationObserver = recompute.createObserver(getCompleteLocalConfiguration);
...
var getIndex = createCachedSelector__default['default']([function (indexes) {
  ...
  if (indexes) {
    var index = _find2__default['default'](indexes, function (index) {
...
function getUniqueIndexes(indexes) {
  if (!_isEmpty2__default['default'](indexes)) {
    return indexes.reduce(function (uniqueIndexes, index) {
      if (_find2__default['default'](uniqueIndexes, function (i) {
...
function removeIndex() {
  ...
  if (indexes && !_isEmpty2__default['default'](indexes)) {
    var clearedIndexes = _reduce2__default['default'](indexes, function (acc, index) {
...
function getUpdatedIndexes(state, filter, order, indexUpdate, changedOn) {
  ...
  if (state[indexesPath]) {
    state[indexesPath].forEach(function (index) {
      if (_isEqual2__default['default'](index.filter, filter) && _isEqual2__default['default'](index.order, order)) {
        selectedIndex = index;
      } else {
        indexes.push(index);
      }
...
function isCorrespondingIndex(index, filter, order) {
  return _isEqual2__default['default'](index.filter || null, filter || null) && _isEqual2__default['default'](index.order || null, order || null);
}
/**
...
function itemFitFilter(filter, item) {
  ...
  return entries.every(function (_ref) {
    ...
    if (itemHasFilterKey) {
      ...
      if (_isObject2__default['default'](value) && value['like']) {
      ...
      if (_isObject2__default['default'](value) && value['in']) {
      ...
      if (_isObject2__default['default'](value) && value['notin']) {
...
function mergeFilters(activeKeys, filterByActive, filter) {
  if (activeKeys && filterByActive) {
    ...
    return _isEmpty2__default['default'](finalFilter) ? null : finalFilter;
  } else {
    return filter;
  }
}
...
function convertModifiersToRequestFriendlyFormat(modifiers) {
  if (modifiers) {
    ...
    return !_isEmpty2__default['default'](modifiersForRequest) ? modifiersForRequest : null;
  } else {
    return null;
  }
}
...
function isNaturalNumber(input) {
  return _isNumber2__default['default'](input) && input > 0 && input % 1 === 0;
}
/**
...
function getSortedValidIntervals(intervals) {
  return _sortBy2__default['default'](getValidIntervals(intervals), ['start', 'length']);
}
/**
...
function mergeIntervals(intervals) {
  ...
  return _tail2__default['default'](sortedIntervals).reduce(function (mergedIntervals, interval) {
  ...
  }, [_head2__default['default'](sortedIntervals)]);
}
/**
 * Add keys to index
 * @param index {Object}
...
var getAllNotRemovedAsObject = function getAllNotRemovedAsObject(getSubstate) {
  return reselect.createSelector([getAllByKey(getSubstate)], function (byKey) {
    if (byKey) {
      return _pickBy2__default['default'](byKey, function (item) {
...
var getActiveModels = function getActiveModels(getSubstate) {
  return reselect.createSelector([getAllAsObject(getSubstate), getActiveKeys(getSubstate)], function (models, activeKeys) {
    ...
    if (models && !_isEmpty2__default['default'](models) && activeKeys && !_isEmpty2__default['default'](activeKeys)) {
...
var getByKey = function getByKey(getSubstate) {
  return createCachedSelector__default['default']([getAllAsObject(getSubstate), function (state, key) {
    ...
    if (key && allData && !_isEmpty2__default['default'](allData) && allData[key]) {
      return allData[key];
    } else {
      return null;
    }
...
var getByKeysAsObject = function getByKeysAsObject(getSubstate) {
  return createCachedSelector__default['default']([getAllAsObject(getSubstate), function (state, keys) {
    ...
    if (keys && keys.length && allData && !_isEmpty2__default['default'](allData)) {
      var data = _pick2__default['default'](allData, keys);

      return _isEmpty2__default['default'](data) ? null : data;
    } else {
      return null;
    }
  })(function (state, keys) {
...
var getByKeys = function getByKeys(getSubstate) {
  return createCachedSelector__default['default']([getByKeysAsObject(getSubstate)], function (asObject) {
    if (asObject) {
...
var getEditedAll = function getEditedAll(getSubstate) {
  return reselect.createSelector([getEditedAllAsObject(getSubstate)], function (editedAsObject) {
...
var getEditedByKey = function getEditedByKey(getSubstate) {
  return createCachedSelector__default['default']([getEditedAllAsObject(getSubstate), function (state, key) {
    return key;
  }], function (allData, key) {
    if (key && allData && !_isEmpty2__default['default'](allData) && allData[key]) {
      return allData[key];
...
var getEditedKeys = function getEditedKeys(getSubstate) {
  return reselect.createSelector([getEditedAllAsObject(getSubstate)], function (edited) {
    if (edited && !_isEmpty2__default['default'](edited)) {
...
var getUsedKeysForComponent = function getUsedKeysForComponent(getSubstate) {
  return createCachedSelector__default['default']([getKeysInUse(getSubstate), function (state, componentKey) {
    return componentKey;
...
var haveAllKeysRegisteredUse = function haveAllKeysRegisteredUse(getSubstate) {
  return createCachedSelector__default['default']([getUsedKeysForComponent(getSubstate), function (state, componentKey, keys) {
    return keys;
  }], function (usedKeys, keys) {
    if (usedKeys && keys !== null && keys !== void 0 && keys.length) {
      var notIncluded = _difference2__default['default'](keys, usedKeys);
...
var getUsedIndexPages = function getUsedIndexPages(getSubstate) {
  return reselect.createSelector([getIndexesInUse(getSubstate), getAllActiveKeys], function (indexedDataUses, activeKeys) {
    var groupedUses = [];
    var finalUsedIndexes = [];

    if (!_isEmpty2__default['default'](indexedDataUses)) {
      _each__default['default'](indexedDataUses, function (usedIndexes) {
        usedIndexes.forEach(function (usedIndex) {
          ...
          var existingIndex = _find2__default['default'](groupedUses, function (use) {
            return _isEqual2__default['default'](use.filter, mergedFilter) && _isEqual2__default['default'](use.order, usedIndex.order);
          });
    ...
    if (!_isEmpty2__default['default'](groupedUses)) {
      _each__default['default'](groupedUses, function (groupedUse) {
...
var getUsedIndexPage = function getUsedIndexPage(getSubstate) {
  return createCachedSelector__default['default'](getUsedIndexPages(getSubstate), function (state, filter) {
    return filter;
  }, function (state, filter, order) {
    return order;
  }, function (usedIndexPages, filter, order) {
    if (usedIndexPages) {
      return _find2__default['default'](usedIndexPages, {
        filter: filter,
        order: order
      });
    } else {
    ...
    var stringFilter = JSON.stringify(_map2__default['default'](filter, function (value, key) {
...
var getUsesWithActiveDependency = function getUsesWithActiveDependency(getSubstate) {
  return reselect.createSelector([getIndexesInUse(getSubstate), getAllActiveKeys, function (state, filterByActive) {
    return filterByActive;
  }],
  /**
  ...
  function (indexedDataUses, activeKeys, filterByActive) {
    ...
    if (filterByActive && !_isEmpty2__default['default'](indexedDataUses)) {
      // loop through components
      _map2__default['default'](indexedDataUses, function (componentUsedIndexes) {
        // loop through uses for component
        _map2__default['default'](componentUsedIndexes, function (usedIndex) {
          if (_reduce2__default['default'](filterByActive, function (accumulator, value, index) {
      ...
      if (!_isEmpty2__default['default'](groupedUses)) {
        _map2__default['default'](groupedUses, function (groupedUse) {
...
var getActiveKeysByFilterByActive = createCachedSelector__default['default']([getAllActiveKeys, function (state, filterByActive) {
  ...
  if (filterByActive && !_isEmpty2__default['default'](filterByActive)) {
    var keys = {};
    ...
    return !_isEmpty2__default['default'](keys) ? keys : null;
  } else {
    return null;
  }
...
var getActiveKeysByFilterByActiveObserver = recompute.createObserver(function (state, filterByActive) {
...
var getMergedModifiers_recompute = recompute.createSelector(function (metadataModifiers, filterByActive) {
...
var getMergedModifiersInRequestFormat_recompute = recompute.createSelector(function (metadataModifiers, filterByActive) {
...
var getCommmonDataRelationsFilterFromComponentState_recompute = recompute.createSelector(function (componentState) {
  var relationsFilter = {};
  ...
  if (!_isEmpty2__default['default'](modifiers)) {
...
var getAllData = reselect.createSelector([getAll$3], function (relations) {
  if (relations) {
    return _map2__default['default'](relations, function (relation) {
...
var getFilteredData = reselect.createSelector([getAllData, function (state, filter) {
  ...
  if (relations && relations.length > 0 && filter && !_isEmpty2__default['default'](filter)) {
...
var getFilteredDataSourceKeysGroupedByLayerKey = createCachedSelector__default['default']([getAll$3, function (state, layers) {
  ...
  if (relations && relations.length) {
    ...
    _forEach2__default['default'](layers, function (layer) {
    ...
    return !_isEmpty2__default['default'](filteredGroupedByLayerKey) ? filteredGroupedByLayerKey : null;
  } else {
    return null;
  }
...
var getAllByKeyObserver = recompute.createObserver(getAllByKey$1);
/**
 * @param state {Object}
...
var getByComponentKey = reselect.createSelector([getAllByKey$1, function (state, key) {
  return key;
...
var getByComponentKey_recompute = recompute.createSelector(function (componentKey) {
  if (componentKey) {
    var components = getAllByKeyObserver();

    if (!_isEmpty2__default['default'](components)) {
...
var get = reselect.createSelector([getByComponentKey, function (state, key, path) {
  return path;
...
var serialize = function serialize(args) {
  return stringify__default['default'](args);
};
...
var getByKeyObserver = recompute.createObserver(function (state, key) {
...
var getByKeys$4 = recompute.createSelector(function (keys) {
...
var getFilteredAttributeDataSourceKeyAttributeKeyPairs = recompute.createSelector(function (filter) {
  ...
  if (relations) {
    ...
    _forEach2__default['default'](relations, function (relation) {
...
var getByKeys$5 = recompute.createSelector(function (keys) {
  if (keys !== null && keys !== void 0 && keys.length) {
    var dataSources = [];
    keys.forEach(function (key) {
...
var getAllAsObjectObserver = recompute.createObserver(function (state) {
  return getSubstate$9(state).byDataSourceKey;
});
var getIndexesObserver$1 = recompute.createObserver(function (state) {
  return getSubstate$9(state).indexes;
});
var getSpatialIndexesObserver = recompute.createObserver(function (state) {
...
var getSpatialIndex_recompute = recompute.createSelector(function (filter, order) {
...
var getDataByDataSourceKeys = recompute.createSelector(function (dataSourceKeys) {
  if (dataSourceKeys) {
    ...
    _forEach2__default['default'](dataSourceKeys, function (key) {
      var attributes = getByDataSourceKeyObserver(key);

      if (attributes && !_isEmpty2__default['default'](attributes)) {
        data[key] = attributes;
      }
    });

    return !_isEmpty2__default['default'](data) ? data : null;
  } else {
    return null;
  }
}, recomputeSelectorOptions);
...
var getAttributesByDataSourceKeysForFeatureKey = recompute.createSelector(function (attributeDataSourceKeyAttributeKeyPairs, featureKey) {
  if (attributeDataSourceKeyAttributeKeyPairs && featureKey) {
    ...
    if (dataByDataSourceKey) {
      ...
      _forIn2__default['default'](dataByDataSourceKey, function (dataSourceData, dataSourceKey) {
      ...
      return !_isEmpty2__default['default'](attributes) ? attributes : null;
    } else {
      return null;
    }
  } else {
...
var getSpatiallyIndexedFeatureKeysByDataSourceKeys = recompute.createSelector(function (filter, level, tile) {
  var spatialIndex = getSpatialIndex_recompute(filter, null);

  if (spatialIndex !== null && spatialIndex !== void 0 && spatialIndex.index && !_isEmpty2__default['default'](spatialIndex)) {
...
var isTileLoading = recompute.createSelector(function (filter, level, tile) {
  if (_isNumber2__default['default'](level) && tile) {
    var index = getSpatialIndex_recompute(filter, null);

    if (index) {
      var _index$index$level;

      var tileIndex = index === null || index === void 0 ? void 0 : (_index$index$level = index.index[level]) === null || _index$index$level === void 0 ? void 0 : _index$index$level[tile];
...
var getComponentStateByKeyObserver = recompute.createObserver(getComponentStateByKey);
/**
...
var isComponentInUse = createCachedSelector__default['default']([getAllComponentsInUse, function (state, componentKey) {
  return componentKey;
}], function (componentsInUse, componentKey) {
  if (componentsInUse !== null && componentsInUse !== void 0 && componentsInUse.length && componentKey) {
    return !!_includes__default['default'](componentsInUse, componentKey);
  } else {
    return false;
  }
})(function (state, componentKey) {
...
var componentMatchesFilterByActive = createCachedSelector__default['default']([getComponentStateByKey, function (state, componentKey, filterByActive) {
  return filterByActive;
  ...
  if (componentState !== null && componentState !== void 0 && componentState.filterByActive && filterByActive) {
    return _isMatch2__default['default'](componentState.filterByActive, filterByActive);
  } else {
    return false;
  }
...
var getAttributeDataFilterExtensionByComponentKey = recompute.createSelector(function (componentKey) {
...
var getCommonFilterByComponentKey = recompute.createSelector(function (componentKey) {
  var componentState = getComponentStateByKeyObserver(componentKey);
...
var getIndexForAttributeDataByComponentKey = recompute.createSelector(function (componentKey) {
  var componentState = getComponentStateByKeyObserver(componentKey);
  ...
  if (componentState) {
    ...
    return !_isEmpty2__default['default'](attributeDataIndex) ? attributeDataIndex : null;
  } else {
    return null;
  }
}); // Data selectors ------------------------------------------------------------------------------------------------------
...
var getData = recompute.createSelector(function (componentKey) {
  var componentState = getComponentStateByKeyObserver(componentKey);
  ...
  if (componentState) {
    var _ret = function () {
      ...
      if (!_isEmpty2__default['default'](data) && attributeKeys !== null && attributeKeys !== void 0 && attributeKeys.length) {
        var attributeDataFilterExtension = getAttributeDataFilterExtensionByComponentKey(componentKey);
        var commonFilter = getCommonFilterByComponentKey(componentKey);
        ...
        if (attributeRelations$1 !== null && attributeRelations$1 !== void 0 && attributeRelations$1.length) {
          ...
          if (indexedFeatureKeysAsObject && !_isEmpty2__default['default'](indexedFeatureKeysAsObject)) {
            var _ret2 = function () {
              ...
              var _loop = function _loop(i) {
                ...
                if (featureKey) {
                  ...
                  _forIn2__default['default'](attributeDsKeyAttributeKeyPairs, function (attributeKey, attributeDsKey) {
                    ...
                    if (value !== undefined) {
                      ...
                      if (finalFeaturesAsObject[i - start]) {
                        finalFeaturesAsObject[i - start].data[attributeKey] = value;
                          ...
                          value = isNaN(value) ? value : _isNumber2__default['default'](value) ? value : Number(value); // TODO format?
...
var getDataForCartesianChart = recompute.createSelector(function (props) {
...
var getIndexesObserver$2 = recompute.createObserver(function (state) {
...
var getByKeys$6 = recompute.createSelector(function (keys) {
  if (keys !== null && keys !== void 0 && keys.length) {
    var dataSources = [];
    keys.forEach(function (key) {
...
var getIndexed_recompute = recompute.createSelector(function (filter) {
...
var getIndexed$6 = createCachedSelector__default['default']([getIndex$6, getAllAsObject$6], function (index, dataSources) {
  if (!_isEmpty2__default['default'](index) && index.index) {
    var dataSourceKeys = Object.values(index.index);

    if (!_isEmpty2__default['default'](dataSourceKeys)) {
...
var getIndexesObserver$3 = recompute.createObserver(function (state) {
...
var getIndexedFeatureKeys = recompute.createSelector(function (filter, level, tile, dataSourceKey) {
  if (_isNumber2__default['default'](level) && tile && dataSourceKey) {
...
var isTileLoading$1 = recompute.createSelector(function (filter, level, tile) {
  if (_isNumber2__default['default'](level) && tile) {
    var index = getIndex_recompute$5(filter, null);
...
var tileAsStringArray = function tileAsStringArray(tile) {
  if (_isArray2__default['default'](tile) && typeof tile[0] === 'string' && typeof tile[1] === 'string') {
    return tile;
  } else if (_isArray2__default['default'](tile)) {
...
var tileAsArray = function tileAsArray(tile) {
  if (typeof tile === 'string' && tile.split(',').length > 1 && tile.split(',').every(function (i) {
    return _isFinite2__default['default'](parseFloat(i));
  })) {
    return tile.split(',').map(parseFloat);
  } else if (_isArray2__default['default'](tile) && tile.length !== 1 && tile.every(function (i) {
    return _isFinite2__default['default'](parseFloat(i));
  })) {
    return tile.map(parseFloat);
  } else if (_isArray2__default['default'](tile) && tile.length === 1) {
...
var getMissingTiles = function getMissingTiles(index, filter) {
  if (index && index.index && filter && _isArray2__default['default'](filter.tiles)) {
    var _index$index;

    //index contains level
    if ((_index$index = index.index) !== null && _index$index !== void 0 && _index$index[filter.level]) {
      var loadedTilesInIndex = _reduce2__default['default'](index.index[filter.level], function (acc, tileData, tileKey) {
    ...
    if (_isArray2__default['default'](filter === null || filter === void 0 ? void 0 : filter.tiles)) {
      // all tiles are missing
      return filter.tiles.map(function (tile) {
        return tileAsStringArray(tile);
      });
...
function getPageSize(localConfig) {
  var PAGE_SIZE = (localConfig === null || localConfig === void 0 ? void 0 : localConfig.requestPageSize) || ptrCore.configDefaults.requestPageSize;
  return PAGE_SIZE;
}
...
var getFeatures = recompute.createSelector(function (dataSourceKey, fidColumnName, attributeDataSourceKeyAttributeKeyPairs) {
  ...
  if (data) {
    return _map2__default['default'](data, function (feature, key) {
      var properties = _defineProperty({}, fidColumnName, key);

      if (attributesByDataSourceKey) {
        _forIn2__default['default'](attributesByDataSourceKey, function (features, attributeDataSourceKey) {
...
var getTile = recompute.createSelector(function (spatialDataSourceKey, fidColumnName, level, tile, spatialRelationsFilter, attributeRelationsFilter, attributeDataSourceKeyAttributeKeyPairs, styleKey, attributeDataFilter) {
...
var getTiles = recompute.createSelector(function (dataSourceKey, fidColumnName, level, tiles, spatialRelationsFilter, attributeRelationsFilter, attributeDataSourceKeyAttributeKeyPairs, styleKey, attributeDataFilter) {
  if (tiles !== null && tiles !== void 0 && tiles.length) {
    var populatedTiles = [];

    _forEach2__default['default'](tiles, function (tile) {
...
var getView = function getView(map, set) {
  if (map) {
    if (set) {
      ...
      if (set.sync && !_isEmpty2__default['default'](set.sync)) {
      ...
      return ptrUtils.map.view.mergeViews(ptrCore.mapConstants.defaultMapView, mapSetView, mapView);
    } else {
      var _map$data2;

      var view = (_map$data2 = map.data) === null || _map$data2 === void 0 ? void 0 : _map$data2.view;
      return ptrUtils.map.view.mergeViews(ptrCore.mapConstants.defaultMapView, view);
    }
  } else {
    return null;
  }
...
var getTiles$1 = createCachedSelector__default['default']([function (mapWidth) {
  ...
  if (mapWidth && mapHeight && center && boxRange) {
    var levelBoxRange = ptrUtils.map.view.getNearestZoomLevelBoxRange(mapWidth, mapHeight, boxRange);
    var tileGrid = ptrTileGrid.grid.getTileGrid(mapWidth, mapHeight, levelBoxRange, center, true);
...
var getByKeyObserver$3 = recompute.createObserver(getByKey$6);
...
var getAllAsObjectWithStyles = reselect.createSelector([getAllAsObject$a, Styles.getAllAsObject], function (selections, allStyles) {
  if (selections) {
    if (allStyles) {
      var selectionsWithStyles = {};

      _forIn2__default['default'](selections, function (selection, key) {
        var _selection$data;
...
var prepareSelectionByLayerStateSelected = recompute.createSelector(function (layerStateSelected) {
  ...
  _forIn2__default['default'](layerStateSelected, function (value, key) {
...
var getActiveMap = reselect.createSelector([getMapsAsObject, getActiveMapKey], function (maps, activeMapKey) {
...
var isMapSetInUse = createCachedSelector__default['default']([getAllMapSetsInUse, function (state, mapSetKey) {
  return mapSetKey;
}], function (mapSetsInUse, mapSetKey) {
  if (mapSetsInUse.length && mapSetKey) {
    return !!_includes__default['default'](mapSetsInUse, mapSetKey);
  } else {
    return false;
  }
...
var isMapInUse = createCachedSelector__default['default']([getAllMapsInUse, function (state, mapKey) {
  return mapKey;
}], function (mapsInUse, mapKey) {
  if (mapsInUse.length && mapKey) {
    return !!_includes__default['default'](mapsInUse, mapKey);
  } else {
    return false;
  }
...
var getMapByKey = reselect.createSelector([getMapsAsObject, function (state, key) {
  return key;
}], function (maps, key) {
...
var getMapSets = reselect.createSelector([getMapSetsAsObject], function (sets) {
  if (sets && !_isEmpty2__default['default'](sets)) {
...
var getAllMapSetsMaps = reselect.createSelector([getMapSets], function (mapSets) {
  if (mapSets) {
    return _flatten2__default['default'](mapSets.map(function (mapSet) {
      return mapSet.maps;
    }));
  } else {
    return null;
...
var getMapSetByMapKey = reselect.createSelector([getMapSets, function (state, mapKey) {
  ...
  if (sets && !_isEmpty2__default['default'](sets) && mapKey) {
    return _find2__default['default'](sets, function (set) {
...
var getMapSetActiveMapView = createCachedSelector__default['default']([getMapSetActiveMapKey, getMapSetByKey, getMapsAsObject], function (mapKey, set, maps) {
...
var getViewByMapKey = createCachedSelector__default['default']([getMapByKey, getMapSetByMapKey], helpers.getView)(function (state, mapKey) {
  return mapKey;
});
...
var getViewportByMapKey = createCachedSelector__default['default']([getMapByKey], function (map) {
  var _map$data;
...
var getViewLimitsByMapKey = createCachedSelector__default['default']([getMapByKey, getMapSetByMapKey], function (map, set) {
  if (map) {
    if (set) {
...
var getMapSetMaps = reselect.createSelector([getMapsAsObject, getMapSetMapKeys], function (maps, mapKeys) {
  if (!_isEmpty2__default['default'](maps) && mapKeys !== null && mapKeys !== void 0 && mapKeys.length) {
...
var getMapLayerStateByMapKeyAndLayerKey = reselect.createSelector([getMapLayersStateByMapKey, function (state, mapKey, layerKey) {
  return layerKey;
...
var getMetadataModifiersByMapKey = createCachedSelector__default['default']([getMapMetadataModifiersByMapKey, getMapSetMetadataModifiersByMapKey], function (mapModifiers, setModifiers) {
...
var getBackgroundLayerStateByMapKeyObserver = recompute.createObserver(getBackgroundLayerStateByMapKey);
/**
 * @param state {Object}
 * @param mapKey {string}
...
var getMapSetLayersStateWithModifiersByMapKey = createCachedSelector__default['default']([getMapSetLayersStateByMapKey, getMapSetMetadataModifiersByMapKey, getMapSetFilterByActiveByMapKey], function (setLayers, metadataModifiers, mapSetFilterByActive) {
...
var getMapLayersStateWithModifiersByMapKey = createCachedSelector__default['default']([getMapLayersStateByMapKey, getMetadataModifiersByMapKey, getFilterByActiveByMapKey], function (mapLayers, metadataModifiers, mapFilterByActive) {
...
var getLayersStateByMapKey = createCachedSelector__default['default']([getMapSetLayersStateWithModifiersByMapKey, getMapLayersStateWithModifiersByMapKey], function (setLayers, mapLayers) {
...
var getLayersStateByMapKeyObserver = recompute.createObserver(getLayersStateByMapKey);
/**
 * @param state {Object}
 * @param mapKey {string}
 * @param layerKey {string}
...
var getLayerStateByLayerKeyAndMapKey = reselect.createSelector([getLayersStateByMapKey, function (state, mapKey, layerKey) {
  return layerKey;
}], function (layers, layerKey) {
  if (layers) {
    var layer = _find2__default['default'](layers, function (layer) {
      return layer.key === layerKey;
    });
...
var getAllLayersStateByMapKey = createCachedSelector__default['default']([getBackgroundLayerStateByMapKey, getLayersStateByMapKey], function (backgroundLayer, layers) {
...
var getVisibleTilesByMapKey = createCachedSelector__default['default']([getViewByMapKey, function (state, mapKey, mapWidth) {
  return mapWidth;
...
var getAttributeDataFilterFromLayerState = recompute.createSelector(function (layerState) {
  if (layerState) {
    var commonFilter = commonSelectors.getCommmonDataRelationsFilterFromComponentState_recompute(layerState);

    if (!_isEmpty2__default['default'](commonFilter)) {
...
var getFinalLayerByDataSourceAndLayerState = recompute.createSelector(function (spatialDataSource, layerState, layerKey, attributeDataSourceKeyAttributeKeyPairs, mapKey, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter) {
  ...
  if (type === 'wmts') {
    ...
    if (url && url.charAt(0) !== 'h') {
      var localConfig = selectors.getCompleteLocalConfigurationObserver();
      url = "".concat(localConfig.apiBackendProtocol, "://").concat(localConfig.apiBackendHost, "/").concat(url);
    }

    options = {
      params: _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, params), styles && {
        styles: styles
      }), crs && {
        crs: crs
      }), {}, {
...
var getMapBackgroundLayer = recompute.createSelector(function (mapKey, layerState) {
  if (!layerState) {
  ...
  if (layerState) {
    if (layerState.type) {
      ...
      if (spatialDataSources) {
        var layers = _compact2__default['default'](spatialDataSources.map(function (dataSource) {
...
var getMapLayers = recompute.createSelector(function (mapKey, layersState) {
  if (!layersState) {
  ...
  if (layersState) {
    ...
    _forEach2__default['default'](layersState, function (layerState) {
      ...
      if (layerState.type) {
        ...
        finalLayers.push(layerState);
          ...
          if (spatialDataSources) {
            _forEach2__default['default'](spatialDataSources, function (dataSource) {
...
var getAsObjectByFullPeriod = createCachedSelector__default['default']([getAllAsObject$b, function (state, limitStart) {
  return limitStart;
}, function (state, limitStart, limitEnd) {
  return limitEnd;
}], function (periods, limitStart, limitEnd) {
  if (periods && limitStart && limitEnd) {
    var selectedPeriods = _pickBy2__default['default'](periods, function (period) {
      ...
      if (periodStart && periodEnd) {
        return moment__default['default'](periodStart).isBetween(limitStart, limitEnd, null, '[]') && moment__default['default'](periodEnd).isBetween(limitStart, limitEnd, null, '[]');
      } else if (periodStart) {
        return moment__default['default'](periodStart).isBetween(limitStart, limitEnd, null, '[]');
      } else if (periodEnd) {
        return moment__default['default'](periodEnd).isBetween(limitStart, limitEnd, null, '[]');
      } else {
        return false;
      }
    });

    return _isEmpty2__default['default'](selectedPeriods) ? null : selectedPeriods;
  } else {
    return null;
  }
})(function (state, limitStart, limitEnd) {
...
var getActiveScopeConfiguration = reselect.createSelector([getActive$d], function (scope) {
  var _scope$data;
...
var getSetByKey = reselect.createSelector([getAllSetsAsObject, function (state, key) {
  return key;
}],
/**
 ...
 */
function (sets, key) {
  if (sets && !_isEmpty2__default['default'](sets) && key && sets[key]) {
    return sets[key];
  } else {
    return null;
  }
...
var getScreensBySetKey = reselect.createSelector([getSetByKey, getAllScreensAsObject],
/**
...
function (sets, lineage) {
  ...
  _forIn2__default['default'](sets, function (value, key) {
...
function (screens, lineage) {
  if (screens && !_isEmpty2__default['default'](screens) && lineage && screens[lineage]) {
...
var getById = reselect.createSelector([getAll$g, function (state, userId) {
  return userId;
...
var isAdminGroupMember = reselect.createSelector([getActive$f], function (user) {
  if (user) {
...
var getActiveUserPermissions = reselect.createSelector([getActive$f], function (user) {
...
var getGroupKeysForActiveUser = reselect.createSelector([getActive$f], function (activeUser) {
...
var getStateToSave$c = reselect.createSelector([Attributes.getStateToSave, AttributeSets.getStateToSave, Components.getStateToSave, Scopes.getStateToSave], function (attributes, attributeSets, components, scopes) {
  return {
...
var getSetByKey$1 = reselect.createSelector([getAllSetsAsObject$1, function (state, key) {
  return key;
}], function (sets, key) {
...
var getWindowsBySetKeyAsObject = reselect.createSelector([getSetByKey$1, getAllWindowsAsObject], function (set, windows) {
...
var updateEdited = function updateEdited(getSubstate, actionTypes) {
  return function (modelKey, key, value) {
    return function (dispatch, getState) {
      ...
      if (originalModel && (value === originalModel.data[key] || _isEqual2__default['default'](originalModel.data[key], value))) {
  ...
  return function (item) {
    return function (dispatch, getState) {
      ...
      return dispatch(apiDelete(dataType, categoryPath, [{
        ...
        if (_isEqual2__default['default'](deletedKeys, [item.key])) {
...
function create(getSubstate, dataType, actionTypes) {
  ...
  return function (key, appKey) {
    return function (dispatch, getState) {
      var state = getState();
      var apiPath = path__default['default'].join('rest', categoryPath);
      ...
      return request(localConfig, apiPath, 'POST', null, payload).then(function (result) {
        if (result.errors && result.errors[dataType] || result.data && !result.data[dataType]) {
          ...
          items.forEach(function (item) {
            indexes = indexes.concat( // Find out indexes which could include new item
            commonSelectors.getIndexesByFilteredItem(getSubstate)(getState(), item)) || [];
          });
          var uniqueIndexes = commonHelpers.getUniqueIndexes(indexes);

          if (!_isEmpty2__default['default'](uniqueIndexes)) {
  ...
  return function (dispatch, getState) {
    ...
    if (data.length) {
      ...
      data.forEach(function (model) {
        ...
        _forIn2__default['default'](edited, function (value, key) {
          if (model.data[key] === value) {
            dispatch(actionRemovePropertyFromEdited(actionTypes, model.key, key));
          } else if (_isObject2__default['default'](value)) {
            if (JSON.stringify(value) === JSON.stringify(model.data[key])) {
              dispatch(actionRemovePropertyFromEdited(actionTypes, model.key, key));
            } else if (_isArray2__default['default'](value) && _isEmpty2__default['default'](value)) {
              if (_isEmpty2__default['default'](model.data[key]) || model.data && !model.data[key]) {
                dispatch(actionRemovePropertyFromEdited(actionTypes, model.key, key));
              }
            }
          }
        ...
        indexes = indexes.concat(commonSelectors.getIndexesByFilteredItem(getSubstate)(getState() || [], model)); //Find corresponding indexes for original model
...
function receiveKeys(actionTypes, result, dataType, keys) {
  return function (dispatch) {
    ...
    _remove__default['default'](keys, function (key) {
      return _find2__default['default'](result.data[dataType], {
        key: key
      });
    });
  ...
  return function () {
    return function (dispatch, getState) {
      ...
      var promises = _flatMap__default['default'](usedIndexPages, function (usedIndexPage) {
        _map2__default['default'](usedIndexPage.uses, function (use) {
  ...
  return function (filterByActive) {
    return function (dispatch, getState) {
      ...
      var promises = _flatMap__default['default'](usedIndexes, function (usedIndex) {
        _map2__default['default'](usedIndex.uses, function (use) {
...
function actionAdd(actionTypes, data, filter) {
  if (!_isArray2__default['default'](data)) data = [data];
...
function actionAddUnreceivedKeys(actionTypes, keys) {
  if (!_isArray2__default['default'](keys)) keys = [keys];
...
var getAPIPath = function getAPIPath() {
  ...
  return path__default['default'].join('rest', categoryPath, 'filtered', dataType);
};
...
function addLoadingIndex(pagination, filter, order) {
  ...
  return actionAddIndex$1(filter, order, data, pagination.offset + 1, null, changedOn);
} // ============ actions ============
...
function actionAddIndex$1(filter, order, data, start, count, changedOn) {
  return {
...
var receiveIndexedWithSpatialIndex = function receiveIndexedWithSpatialIndex(attributeData, spatialIndexData, attributeDataFilter, order, changedOn) {
  return function (dispatch) {
    if (!_isEmpty2__default['default'](attributeData)) {
      dispatch(addDataAndIndexBasedOnSpatialData(attributeDataFilter, order, attributeData, spatialIndexData, changedOn));
    } else {
      // add to index
      dispatch(createAndAddIndexBasedOnSpatialData(attributeDataFilter, order, spatialIndexData, changedOn));
    }
  };
};
/**
...
var receiveIndexed$3 = function receiveIndexed(attributeData, attributeDataFilter, order, start, total, changedOn) {
  return actionAddDataAndIndex(attributeDataFilter, order, total, start, attributeData.index, attributeData.attributeData, changedOn);
};
/**
...
function addDataAndIndexBasedOnSpatialData(attributeDataFilter, order, attributeData, spatialIndexData, changedOn) {
  return function (dispatch) {
    for (var _i = 0, _Object$keys = Object.keys(attributeData); _i < _Object$keys.length; _i++) {
      var attributeDataSourceKey = _Object$keys[_i];
      dispatch(actionAddDataAndIndexBasedOnSpatialData(attributeDataSourceKey, attributeData[attributeDataSourceKey], attributeDataFilter, order, [spatialIndexData], changedOn));
    }
  };
}
/**
...
function createAndAddIndexBasedOnSpatialData(attributeDataFilter, order, spatialIndexData, changedOn) {
  return actionAddIndexWithSpatialIndex(attributeDataFilter, order, [spatialIndexData], changedOn);
}
/**
...
function addLoadingSpatialIndex(attributeDataFilter, order, level, tiles) {
  ...
  var loadingTiles = _reduce2__default['default'](tiles, function (acc, tile) {
  ...
  return actionAddIndexWithSpatialIndex(attributeDataFilter, order, [index], changedOn);
}
/**
...
function addLoadingIndex$1(pagination, attributeDataFilter, order) {
  ...
  return actionAddIndex$2(attributeDataFilter, order, data, pagination.offset + 1, null, changedOn);
} // ============ helpers ============
  ...
  for (var _i2 = 0, _Object$entries = Object.entries(spatialData); _i2 < _Object$entries.length; _i2++) {
    ...
    for (var _i3 = 0, _Object$entries2 = Object.entries(datasource.spatialIndex); _i3 < _Object$entries2.length; _i3++) {
      ...
      for (var _i4 = 0, _Object$entries3 = Object.entries(tiles); _i4 < _Object$entries3.length; _i4++) {
        ...
        if (!indexByLevelByTileByDataSourceKey[level][tileAsString(tile)] || _isEmpty2__default['default'](attributeData)) {
...
function actionAddDataAndIndexBasedOnSpatialData(attributeDataSourceKey, data, attributeDataFilter, order, indexData, changedOn) {
  return {
...
function actionAddDataAndIndex(attributeDataFilter, order, total, start, index, data, changedOn) {
  return {
...
function actionAddIndexWithSpatialIndex(attributeDataFilter, order, index, changedOn) {
  return {
...
function actionAddIndex$2(attributeDataFilter, order, data, start, count, changedOn) {
  return {
...
var attributeData$1 = {
  ...
  receiveIndexedWithSpatialIndex: receiveIndexedWithSpatialIndex,
...
function getRestPages(count, PAGE_SIZE) {
  ...
  optStart = _isNumber2__default['default'](optStart) ? optStart : 1;

  if (_isNumber2__default['default'](count) && (count === 0 || optStart > count)) {
    return [];
  } else {
    var wanted;

    if (_isNumber2__default['default'](count)) {
      wanted = count - optStart + 1; // Request specific number of results

      if (_isNumber2__default['default'](optLength)) {
...
function getPagination(pageIndex) {
  ...
  if (_isNumber2__default['default'](optLength) && pageIndex * pageSize + pageSize > optLength) {
    limit = Math.max(0, optLength - pageIndex * pageSize);
  }

  if (_isNumber2__default['default'](optCount) && optStart + pageIndex * pageSize + limit - 1 > optCount) {
...
function getLoadedPages() {
  ...
  pages.forEach(function (pageIndex) {
    ...
    if (_isNumber2__default['default'](optCount)) {
      if (_isNumber2__default['default'](optLength) && pageSize * (pageIndex + 1) > optLength) {
...
function getMissingPages(optDataIndex, pageSize, optStart, optLength) {
  ...
  var missingPages = _difference2__default['default'](restPages, loadedPages);
...
var DEFAULT_PAGE_PAGINATION = {
  offset: 0,
  limit: ptrCore.configDefaults.requestPageSize
};
/**
...
function updateComponent(componentKey, update) {
  return function (dispatch, getState) {
    ...
    dispatch(actionAddOrReplaceComponents(_defineProperty({}, componentKey, _merge2__default['default'](componentState, update))));
  };
}
/**
...
function ensureDataAndRelations(componentKey, order, commonFilter, attributeDataFilterExtension, start, length, PAGE_SIZE, loadRelations, loadData, attributePagination, relationsPagination) {
  return function (dispatch, getState) {
    var state = getState(); // Update recompute state before ask cached selectors.

    recompute.setState(state);
    var localConfig = Select.app.getCompleteLocalConfiguration(state);
...
function loadMissingRelationsAndData(componentKey, order, commonFilter, attributeDataFilterExtension, remainingRelationsPages, remainingAttributeDataPages, start, length, PAGE_SIZE) {
  return function (dispatch, getState) {
    ...
    for (var i = 1; i <= remainingRelationsPages.length; i++) {
      ...
      promises.push(dispatch(loadIndexedPage$1(order, commonFilter, attributeDataFilterExtension, loadRelations, loadData, relationsPagination, attributePagination)));
...
var ensure = function ensure(componentKey) {
  return function (dispatch, getState) {
    ...
    if (componentState) {
      ...
      if (!_isEmpty2__default['default'](attributeDataIndex)) {
      ...
      if (!_isEmpty2__default['default'](attributeDataIndex) && !_isEmpty2__default['default'](attributeRelationsIndex)) {
  ...
  return function (dispatch) {
    if (result.attributeData || result.attributeRelationsDataSources) {
      ...
      if (result.attributeData.attributeData) {
        var _changes = null;
        dispatch(attributeData$1.receiveIndexed(result.attributeData, attributeDataFilter, order, result.attributeData.offset + 1, result.attributeData.total, _changes));
      }
    }
  };
};
...
var actionAddOrReplaceComponents = function actionAddOrReplaceComponents(components) {
  return {
    type: commonActionTypes.DATA.COMPONENTS.ADD_COMPONENTS,
    components: components
  };
};
...
var DataComponentsActions = {
  addComponentsFromView: addComponentsFromView,
...
var receiveIndexed$6 = function receiveIndexed(spatialData, filter, order, changedOn) {
  return function (dispatch) {
    if (spatialData && !_isEmpty2__default['default'](spatialData)) {
...
function addDataAndIndex(spatialDataAndIndexByDataSourceKey, filter, order, changedOn) {
  return function (dispatch) {
    ...
    _forIn2__default['default'](spatialDataAndIndexByDataSourceKey, function (value, spatialDataSourceKey) {
      spatialDataByDataSourceKey[spatialDataSourceKey] = value.data;
    });

    dispatch(actionAddDataAndIndex$1(spatialDataByDataSourceKey, level, filter, order, [indexByLevelByTileByDataSourceKey], changedOn));
  };
}
/**
 * Create new index based on given level and tiles with loading indicator.
...
function addLoadingIndex$2(filter, order, level, tiles) {
  ...
  return actionAddIndex$3(filter, order, [index], changedOn);
} // ============ helpers ============
...
function actionAddDataAndIndex$1(dataByDataSourceKey, level, filter, order, indexData, changedOn) {
  return {
...
function actionAddIndex$3(filter, order, index, changedOn) {
  return {
  ...
  return function (dispatch, getState) {
    ...
    if (promises.length > 0) {
      return Promise.all(promises).then(function () {
        ...
        var spatialDataSourcesTypes = _flattenDeep2__default['default'](response.map(function (r) {
        ...
        var allSourcesAreUnsupported = !_isEmpty2__default['default'](spatialDataSourcesPairs) ? spatialDataSourcesPairs.every(function (ds) {
...
function loadMissingAttributeData(spatialFilter, styleKey, order, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter) {
  return function (dispatch, getState) {
    ...
    var loadAttributeRelationsAndDS = !(!_isEmpty2__default['default'](attributeRelations) && !_isEmpty2__default['default'](attributeDataSources)); //load only attribute data
...
function ensureDataAndRelations$1(spatialFilter, styleKey, order, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter) {
  return function (dispatch, getState) {
    ...
    if (spatialFilter && !_isEmpty2__default['default'](spatialFilter)) {
      // Only if spatialIndex is null then is set whole spatialFilter.tiles as loading true in one step
      var spatialIndex = null;
...
function ensure$1(styleKey, commonRelationsFilter, spatialFilter, attributeDataFilterExtension) {
  return function (dispatch, getState) {
    ...
    if (!loadRelationsAndData && missingAttributesData) {
      ...
      var missingAttributeDataTilesToLoad = _difference2__default['default'](missingAttributeDataTiles, missingSpatialDataTiles);

      var missingSpatialAndAttributeDataTiles = _intersection2__default['default'](missingAttributeDataTiles, missingSpatialDataTiles);
    ...
    if (filterHasSpatialOrAreaRelations && missingSpatialData && !_isEmpty2__default['default'](modifiedSpatialFilterForSpatial.tiles)) {
    ...
    if (!loadRelationsAndData && !_isEmpty2__default['default'](modifiedSpatialFilterForAttributes.tiles)) {
...
function processResult$1(result, loadGeometry, loadAttributeRelations, loadSpatialRelations, order, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter, start) {
  return function (dispatch, getState) {
    ...
    // Attributes
    ////
    if (!!loadAttributeRelations && result.spatialAttributeRelationsDataSources.attributeRelations && !_isEmpty2__default['default'](result.spatialAttributeRelationsDataSources.attributeRelations)) {
      var changes = null;
    ...
    if (!!loadAttributeRelations && result.spatialAttributeRelationsDataSources.attributeDataSources && !_isEmpty2__default['default'](result.spatialAttributeRelationsDataSources.attributeDataSources)) {
      var _changes = null;
    ...
    if (result.spatialData && result.attributeData) {
      var _changes2 = null;
      var spatialIndexData = attributeData$1.getIndexDataBySpatialData(result.spatialData, result.attributeData);
      dispatch(attributeData$1.receiveIndexedWithSpatialIndex(result.attributeData, spatialIndexData, attributeDataFilter, order, _changes2));
    } ////
    // Spatial data
    ////


    if (!!loadSpatialRelations && result.spatialAttributeRelationsDataSources.spatialRelations && !_isEmpty2__default['default'](result.spatialAttributeRelationsDataSources.spatialRelations)) {
      var _changes3 = null;
    ...
    if (!!loadSpatialRelations && result.spatialAttributeRelationsDataSources.spatialDataSources && !_isEmpty2__default['default'](result.spatialAttributeRelationsDataSources.spatialDataSources)) {
      var _changes4 = null;
...
function setLoading(attributeDataFilter, spatialIndex, spatialFilter, spatialRelationsFilter, order, loadGeometry) {
  return function (dispatch, getState) {
    ...
    var spatialTilesInNotLoadingState = _reduce2__default['default'](loadingTilesGeometry, function () {
    ...
    var attributesTilesInNotLoadingState = _reduce2__default['default'](loadingTilesGeometry, function () {
      var acc = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var tile = arguments.length > 1 ? arguments[1] : undefined;
...
var addMapLayers = function addMapLayers(mapKey, layerStates) {
  return function (dispatch, getState) {
    var state = getState();
    var map = Select.maps.getMapByKey(state, mapKey);

    if (map) {
      dispatch(actionAddMapLayers(mapKey, layerStates));
      var viewport = Select.maps.getViewportByMapKey(state, mapKey);

      if (viewport) {
        dispatch(use$1(mapKey, null, null, viewport.width, viewport.height));
      }
    } else {
      dispatch(commonActions.actionGeneralError("No map exists for mapKey ".concat(mapKey)));
    }
  };
};
/**
...
var removeMapLayer = function removeMapLayer(mapKey, layerKey) {
  return function (dispatch, getState) {
    var state = getState();
    var layerState = Select.maps.getLayerStateByLayerKeyAndMapKey(state, mapKey, layerKey);

    if (layerState) {
      dispatch(actionRemoveMapLayer(mapKey, layerKey));
    } else {
      dispatch(commonActions.actionGeneralError("No layer with key ".concat(layerKey, " found for mapKey ").concat(mapKey)));
    }
  };
};
/**
...
function use$1(mapKey, backgroundLayer, layers, mapWidth, mapHeight) {
  return function (dispatch, getState) {
    ...
    var state = getState();
    var spatialFilter = Select.maps.getVisibleTilesByMapKey(state, mapKey, mapWidth, mapHeight); //spatial filter is required for now
    ...
    if (mapKeys && activeKeys) {
      mapKeys.forEach(function (mapKey) {
        ...
        if (mapViewport) {
          ...
          var spatialFilter = Select.maps.getVisibleTilesByMapKey(state, mapKey, width, height);
          ...
          if (spatialFilter) {
            ...
            if (layers) {
              layers.forEach(function (layer) {
                if (layer.filterByActive && _isMatch2__default['default'](layer.filterByActive, filterByActive)) {
                  // apply layerUse asynchronous on each leyer
                  // it cause better FPS and prevent long synchronous tasks
                  setTimeout(function () {
                    dispatch(layerUse(layer, spatialFilter));
...
function setMapLayerOption(mapKey, layerKey, optionKey, optionValue) {
  return function (dispatch, getState) {
    ...
    if (layer) {
      ...
      dispatch(commonActions.actionGeneralError("No layer found for mapKey ".concat(mapKey, " and layerKey ").concat(layerKey)));
    }
  };
}
/**
...
function setMapBackgroundLayer(mapKey, backgroundLayer) {
  return function (dispatch, getState) {
    var map = Select.maps.getMapByKey(getState(), mapKey);
    ...
    if (map) {
      ...
      if (!backgroundLayer.type) {
        ...
        var backgroundLayerState = Select.maps.getMapBackgroundLayerStateByMapKey(getState(), mapKey);
        var spatialFilter = Select.maps.getVisibleTilesByMapKey(getState(), mapKey, map === null || map === void 0 ? void 0 : (_map$data3 = map.data) === null || _map$data3 === void 0 ? void 0 : (_map$data3$viewport = _map$data3.viewport) === null || _map$data3$viewport === void 0 ? void 0 : _map$data3$viewport.width, map === null || map === void 0 ? void 0 : (_map$data4 = map.data) === null || _map$data4 === void 0 ? void 0 : (_map$data4$viewport = _map$data4.viewport) === null || _map$data4$viewport === void 0 ? void 0 : _map$data4$viewport.height); //spatial filter is required for now
...
function setMapSetLayers(setKey, layers) {
  return function (dispatch, getState) {
    var set = Select.maps.getMapSetByKey(getState(), setKey);
    ...
    if (set) {
      ...
      if (maps) {
        maps.forEach(function (map) {
          ...
          dispatch(use$1(map.key, null, null, map === null || map === void 0 ? void 0 : (_map$data5 = map.data) === null || _map$data5 === void 0 ? void 0 : (_map$data5$viewport = _map$data5.viewport) === null || _map$data5$viewport === void 0 ? void 0 : _map$data5$viewport.width, map === null || map === void 0 ? void 0 : (_map$data6 = map.data) === null || _map$data6 === void 0 ? void 0 : (_map$data6$viewport = _map$data6.viewport) === null || _map$data6$viewport === void 0 ? void 0 : _map$data6$viewport.height));
        });
      }
    } else {
      dispatch(commonActions.actionGeneralError("No set exists for setKey ".concat(setKey)));
    }
  };
}
/**
  ...
  return function (dispatch, getState) {
    ...
    if (mapSetMapKeys && mapSetMapKeys.includes(mapKey)) {
      ...
      if (activeMapKey === mapKey) {
        ...
        if (!_isEmpty2__default['default'](_mapSetMapKeys)) {
...
function updateMapAndSetView(mapKey, update) {
  return function (dispatch, getState) {
    ...
    if (set && set.sync && map) {
      ...
      forSet = _pickBy2__default['default'](update, function (updateVal, updateKey) {
    ...
    if (forSet && !_isEmpty2__default['default'](forSet)) {
    ...
    if (forMap && !_isEmpty2__default['default'](forMap)) {
      //check data integrity
...
function setMapViewport(mapKey, width, height) {
  return function (dispatch, getState) {
    if (mapKey && _isNumber2__default['default'](width) && _isNumber2__default['default'](height)) {
      var state = getState();
...
var actionAddMapLayers = function actionAddMapLayers(mapKey, layerStates) {
  return {
    type: commonActionTypes.MAPS.MAP.LAYERS.ADD,
    mapKey: mapKey,
...
var actionAddMapLayerToIndex = function actionAddMapLayerToIndex(mapKey, layerState, index) {
  return {
    type: commonActionTypes.MAPS.MAP.LAYERS.ADD_TO_INDEX,
    mapKey: mapKey,
...
var actionRemoveMapLayer = function actionRemoveMapLayer(mapKey, layerKey) {
  return {
    type: commonActionTypes.MAPS.MAP.LAYERS.REMOVE_LAYER,
    mapKey: mapKey,
    layerKey: layerKey
  };
};
...
var actionSetActiveMapKey = function actionSetActiveMapKey(mapKey) {
  return {
    type: commonActionTypes.MAPS.SET_ACTIVE_MAP_KEY,
    mapKey: mapKey
  };
};
...
var actionSetMapLayerOption = function actionSetMapLayerOption(mapKey, layerKey, optionKey, optionValue) {
  return {
    type: commonActionTypes.MAPS.MAP.LAYERS.SET_OPTION,
    mapKey: mapKey,
    layerKey: layerKey,
    optionKey: optionKey,
...
var actionSetMapBackgroundLayer = function actionSetMapBackgroundLayer(mapKey, backgroundLayer) {
  return {
    type: commonActionTypes.MAPS.MAP.SET_BACKGROUND_LAYER,
    mapKey: mapKey,
    backgroundLayer: backgroundLayer
  };
};
...
var actionSetMapSetLayers = function actionSetMapSetLayers(setKey, layers) {
  return {
    type: commonActionTypes.MAPS.SET.SET_LAYERS,
    setKey: setKey,
    layers: layers
  };
};
...
function updateStateFromView$9(data) {
  return function (dispatch) {
    if (data) {
      if (data && data.byKey) {
        dispatch(add$c(_values__default['default'](data.byKey)));
      }
...
function apiLogoutUser(ttl) {
  ...
  return function (dispatch, getState) {
    ...
    var url = apiBackendProtocol + '://' + path__default['default'].join(apiBackendHost, 'api/login/logout');
    return _fetch__default['default'](url, {
      method: 'POST',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json',
...
function transformUser(user) {
  return _objectSpread2(_objectSpread2({}, user), {}, {
    ...
    groups: _map2__default['default'](user.groups, 'key')
  });
} //TODO remove -> workaround with permissions.guest.get
  ...
  return function (dispatch, getState) {
    return dispatch(commonActions.ensureKeys(Select.views.getSubstate, 'views', commonActionTypes.VIEWS, [key], 'views')).then(function () {
      ...
      if (data && data.state) {
        ...
        _each__default['default'](actions, function (storeActions, key) {
        ...
        if (actions.data.components && (_data$state$data = data.state.data) !== null && _data$state$data !== void 0 && _data$state$data.components) {
          actionCreators.push(actions.data.components.addComponentsFromView(data.state.data.components));
        }

        if (actions.specific) {
          _each__default['default'](actions.specific, function (storeActions, key) {
            if (storeActions.hasOwnProperty('updateStateFromView') && data.state[key]) {
              actionCreators.push(storeActions.updateStateFromView(data.state[key]));
            }
          });
...
var AppContainer = reactRedux.connect(mapStateToProps, mapDispatchToProps);
...
var CartesianChart = reactRedux.connect(mapStateToProps$1, mapDispatchToPropsFactory);
...
var mapDispatchToPropsFactory$1 = function mapDispatchToPropsFactory() {
  var componentId = 'Map_' + ptrUtils.utils.randomString(6);
  return function (dispatch, ownProps) {
    if (ownProps.stateMapKey) {
      return {
...
var Map = reactRedux.connect(mapStateToProps$2, mapDispatchToPropsFactory$1);
...
var mapDispatchToPropsFactory$2 = function mapDispatchToPropsFactory() {
  var componentId = 'MapSet_' + ptrUtils.utils.randomString(6);
  return function (dispatch, ownProps) {
    if (ownProps.stateMapSetKey) {
      return {
        onMount: function onMount() {
...
var MapSet = reactRedux.connect(mapStateToProps$3, mapDispatchToPropsFactory$2);
...
var Screens$2 = reactRedux.connect(mapStateToProps$4, mapDispatchToProps$1);
...
var User = reactRedux.connect(mapStateToProps$5, mapDispatchToProps$2);
...
var WindowsContainer = reactRedux.connect(mapStateToProps$6, mapDispatchToProps$3);
  ...
  return /*#__PURE__*/function (_React$PureComponent) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        return /*#__PURE__*/React__default['default'].createElement(Component, this.props);
      }
    }]);
...
var commonReducers = {
  ...
  addIndex: function addIndex(state, action) {
    if (action !== null && action !== void 0 && action.data) {
      ...
      var indexOfIndex = updatedIndexes.length ? _findIndex2__default['default'](state.indexes, function (index) {
        return _isEqual2__default['default'](index.filter, action.filter) && _isEqual2__default['default'](index.order, action.order);
      ...
      if (indexOfIndex > -1) {
        ...
        var updatedIndexIndex = commonHelpers.registerModelsToIndex(_objectSpread2({}, updatedIndex.index), action.data, action.start); // Remove loading indicator if data on this position doesn't exist
  ...
  registerUseIndexed: function registerUseIndexed(state, action) {
    ...
    if (state.inUse.indexes && state.inUse.indexes[action.componentId]) {
      existingUse = _find2__default['default'](state.inUse.indexes[action.componentId], newUse);
  ...
  useIndexedClear: function useIndexedClear(state, action) {
    ...
    if (action.componentId && (_state$inUse = state.inUse) !== null && _state$inUse !== void 0 && (_state$inUse$indexes = _state$inUse.indexes) !== null && _state$inUse$indexes !== void 0 && _state$inUse$indexes.hasOwnProperty(action.componentId)) {
      ...
      return _objectSpread2(_objectSpread2({}, state), {}, {
        inUse: _objectSpread2(_objectSpread2({}, state.inUse), {}, {
          indexes: _isEmpty2__default['default'](indexes) ? null : indexes
        })
      });
    } else {
      return state;
  ...
  useKeysRegister: function useKeysRegister(state, action) {
    ...
    if (action.componentId && (_action$keys2 = action.keys) !== null && _action$keys2 !== void 0 && _action$keys2.length) {
      ...
      return _objectSpread2(_objectSpread2({}, state), {}, {
        inUse: _objectSpread2(_objectSpread2({}, state.inUse), {}, {
          keys: _objectSpread2(_objectSpread2({}, state.inUse.keys), {}, _defineProperty({}, action.componentId, (_state$inUse$keys = state.inUse.keys) !== null && _state$inUse$keys !== void 0 && _state$inUse$keys[action.componentId] ? _union2__default['default'](state.inUse.keys[action.componentId], action.keys) : action.keys))
        })
      });
    } else {
      return state;
  ...
  useKeysClear: function useKeysClear(state, action) {
    if (action.componentId) {
      ...
      return _objectSpread2(_objectSpread2({}, state), {}, {
        inUse: _objectSpread2(_objectSpread2({}, state.inUse), {}, {
          keys: _isEmpty2__default['default'](keys) ? null : keys
        })
      });
    } else {
      return state;
  ...
  remove: function remove(state, action) {
    ...
    if ((_action$keys3 = action.keys) !== null && _action$keys3 !== void 0 && _action$keys3.length && state.byKey) {
      var updatedByKey = _omit2__default['default'](state.byKey, action.keys);

      return _objectSpread2(_objectSpread2({}, state), {}, {
        byKey: _isEmpty2__default['default'](updatedByKey) ? null : updatedByKey
      });
    } else {
      return state;
    }
  ...
  removeEdited: function removeEdited(state, action) {
    ...
    if ((_action$keys4 = action.keys) !== null && _action$keys4 !== void 0 && _action$keys4.length && state.editedByKey) {
      var updatedEditedByKey = _omit2__default['default'](state.editedByKey, action.keys);

      return _objectSpread2(_objectSpread2({}, state), {}, {
        editedByKey: _isEmpty2__default['default'](updatedEditedByKey) ? null : updatedEditedByKey
      });
    } else {
      return state;
    }
  ...
  removeEditedActive: function removeEditedActive(state, action) {
    if (state.activeKey && state.editedByKey) {
      var updatedEditedByKey = _omit2__default['default'](state.editedByKey, state.activeKey);
  ...
  removeEditedProperty: function removeEditedProperty(state, action) {
    if (action.key && state.editedByKey) {
      ...
      if (editedModelData !== null && editedModelData !== void 0 && editedModelData.hasOwnProperty(action.property)) {
        ...
        if (_isEmpty2__default['default'](restProps)) {
          var editedModels = _objectSpread2({}, state.editedByKey);

          delete editedModels[action.key];
          return _objectSpread2(_objectSpread2({}, state), {}, {
            editedByKey: _isEmpty2__default['default'](editedModels) ? null : editedModels
          });
        } else {
          return _objectSpread2(_objectSpread2({}, state), {}, {
  ...
  clearIndexes: function clearIndexes(state, action) {
    ...
    if ((_state$indexes = state.indexes) !== null && _state$indexes !== void 0 && _state$indexes.length) {
      var indexes = _map2__default['default'](state.indexes, function (index) {
...
function ensureDependenciesOfActiveMetadataType(filterKey) {
  return function (dispatch) {
    ...
    _forIn2__default['default'](STORES_TO_ENSURE_WITH_FILTER_BY_ACTIVE, function (params) {
...
var areasReducers = redux.combineReducers({
...
function update$1(state, componentKey, update) {
  if (!_isEmpty2__default['default'](update)) {
...
var addWithSpatialIndex = function addWithSpatialIndex(state, attributeDataSourceKey, data, filter, order, indexData, changedOn) {
  var byDataSourceKey = _objectSpread2(_objectSpread2({}, state.byDataSourceKey), {}, _defineProperty({}, attributeDataSourceKey, state.byDataSourceKey[attributeDataSourceKey] ? _objectSpread2(_objectSpread2({}, state.byDataSourceKey[attributeDataSourceKey]), data) : data));
...
var componentUseClear$1 = function componentUseClear(state, componentKey) {
  if (componentKey && !_isEmpty2__default['default'](state.components.inUse)) {
    var index = _indexOf2__default['default'](state.components.inUse, componentKey);

    if (index > -1) {
      var updatedInUse = ptrUtils.stateManagement.removeItemByIndex(state.components.inUse, index);
      return _objectSpread2(_objectSpread2({}, state), {}, {
...
var addOrReplaceComponents = function addOrReplaceComponents(state, componentsByKey) {
  if (componentsByKey) {
    return _objectSpread2(_objectSpread2({}, state), {}, {
      components: _objectSpread2(_objectSpread2({}, state.components), {}, {
...
var components$1 = (function () {
  ...
  switch (action.type) {
    ...
    case commonActionTypes.DATA.COMPONENTS.ADD_COMPONENTS:
...
function getUpdatedByDataSourceKey$1(state, dataByDataSourceKey, level) {
  ...
  _forIn2__default['default'](dataByDataSourceKey, function (data, dataSourceKey) {
    ...
    _forIn2__default['default'](data, function (geometry, featureKey) {
...
var dataReducers = redux.combineReducers({
...
var removeMapFromSet$1 = function removeMapFromSet(state, setKey, mapKey) {
  if (setKey && mapKey) {
    ...
    var index = _indexOf2__default['default']((_state$sets$setKey = state.sets[setKey]) === null || _state$sets$setKey === void 0 ? void 0 : _state$sets$setKey.maps, mapKey);

    if (index > -1) {
      var updatedMaps = ptrUtils.stateManagement.removeItemByIndex(state.sets[setKey].maps, index);
      return _objectSpread2(_objectSpread2({}, state), {}, {
...
var removeMapLayer$1 = function removeMapLayer(state, mapKey, layerKey) {
  if (layerKey && mapKey) {
    var _state$maps$mapKey;

    var index = _findIndex2__default['default']((_state$maps$mapKey = state.maps[mapKey]) === null || _state$maps$mapKey === void 0 ? void 0 : _state$maps$mapKey.data.layers, {
      key: layerKey
    });
    ...
    if (index > -1) {
      ...
      var updatedLayers = ptrUtils.stateManagement.removeItemByIndex((_state$maps$mapKey2 = state.maps[mapKey]) === null || _state$maps$mapKey2 === void 0 ? void 0 : _state$maps$mapKey2.data.layers, index);
      return _objectSpread2(_objectSpread2({}, state), {}, {
...
var addMapLayers$1 = function addMapLayers(state, mapKey, layerStates) {
  var _state$maps;
...
var addMapLayerToIndex$1 = function addMapLayerToIndex(state, mapKey, layerState, index) {
  var _state$maps2;
  ...
  if (mapKey && layerState && (_state$maps2 = state.maps) !== null && _state$maps2 !== void 0 && _state$maps2[mapKey]) {
    ...
    if (currentLayers) {
      if (index > -1 && index < currentLayers.length) {
        updatedLayers = ptrUtils.stateManagement.addItemToIndex(currentLayers, index, layerState);
      } else {
...
var setMapLayerOption$1 = function setMapLayerOption(state, mapKey, layerKey, optionKey, optionValue) {
  ...
  if (layers) {
    var updatedLayers = layers.map(function (item) {
      if (item.key === layerKey) {
        return _objectSpread2(_objectSpread2({}, item), {}, {
          options: _objectSpread2(_objectSpread2({}, item.options), {}, _defineProperty({}, optionKey, optionValue))
        });
      } else {
        return item;
      }
...
var setMapBackgroundLayer$1 = function setMapBackgroundLayer(state, mapKey, backgroundLayer) {
  return _objectSpread2(_objectSpread2({}, state), {}, {
    maps: _objectSpread2(_objectSpread2({}, state.maps), {}, _defineProperty({}, mapKey, _objectSpread2(_objectSpread2({}, state.maps[mapKey]), {}, {
      data: _objectSpread2(_objectSpread2({}, state.maps[mapKey].data), {}, {
        backgroundLayer: backgroundLayer
...
var updateMapView = function updateMapView(state, mapKey, updates) {
  if (updates && !_isEmpty2__default['default'](updates)) {
    return _objectSpread2(_objectSpread2({}, state), {}, {
      maps: _objectSpread2(_objectSpread2({}, state.maps), {}, _defineProperty({}, mapKey, _objectSpread2(_objectSpread2({}, state.maps[mapKey]), {}, {
        data: _objectSpread2(_objectSpread2({}, state.maps[mapKey].data), {}, {
...
var mapUseClear$1 = function mapUseClear(state, mapKey) {
  if (mapKey) {
    var index = _indexOf2__default['default'](state.inUse.maps, mapKey);

    if (index > -1) {
      var updatedInUse = ptrUtils.stateManagement.removeItemByIndex(state.inUse.maps, index);
      return _objectSpread2(_objectSpread2({}, state), {}, {
        inUse: _objectSpread2(_objectSpread2({}, state.inUse), {}, {
          maps: updatedInUse
        })
...
var mapSetUseClear$1 = function mapSetUseClear(state, mapSetKey) {
  if (mapSetKey) {
    var index = _indexOf2__default['default'](state.inUse.sets, mapSetKey);

    if (index > -1) {
      var updatedInUse = ptrUtils.stateManagement.removeItemByIndex(state.inUse.sets, index);
      return _objectSpread2(_objectSpread2({}, state), {}, {
        inUse: _objectSpread2(_objectSpread2({}, state.inUse), {}, {
          sets: updatedInUse
        })
...
function tasksReducer() {
  ...
  switch (action.type) {
    case commonActionTypes.MAPS.MAP.LAYERS.ADD:
      return addMapLayers$1(state, action.mapKey, action.layerStates);

    case commonActionTypes.MAPS.MAP.LAYERS.ADD_TO_INDEX:
      return addMapLayerToIndex$1(state, action.mapKey, action.layerState, action.index);

    case commonActionTypes.MAPS.MAP.LAYERS.REMOVE_LAYER:
      return removeMapLayer$1(state, action.mapKey, action.layerKey);

    case commonActionTypes.MAPS.MAP.LAYERS.SET_OPTION:
      return setMapLayerOption$1(state, action.mapKey, action.layerKey, action.optionKey, action.optionValue);
    ...
    case commonActionTypes.MAPS.MAP.SET_BACKGROUND_LAYER:
      return setMapBackgroundLayer$1(state, action.mapKey, action.backgroundLayer);
    ...
    case commonActionTypes.MAPS.SET.SET_LAYERS:
    ...
    case commonActionTypes.MAPS.SET_ACTIVE_MAP_KEY:
...
var remove = function remove(state, action) {
  ...
  var orderByHistory = _without__default['default'](_toConsumableArray(sets[action.setKey].orderByHistory), action.lineage);

  var orderBySpace = _without__default['default'](_toConsumableArray(sets[action.setKey].orderBySpace), action.lineage);
...
var update$4 = function update(state, action) {
  ...
  var orderByHistory = _without__default['default'](sets[action.setKey].orderByHistory, action.lineage);

  orderByHistory.push(action.lineage);
  sets[action.setKey].orderByHistory = orderByHistory;

  var alreadyInOrder = _find2__default['default'](sets[action.setKey].orderBySpace, function (lineage) {
    return lineage === action.lineage;
  });

  if (!alreadyInOrder) {
    var orderBySpace = _without__default['default'](sets[action.setKey].orderBySpace, action.lineage);
...
var remove$1 = function remove(state, action) {
  ...
  if (_isEmpty2__default['default'](sets) || _isEmpty2__default['default'](sets[action.setKey]) || !action.windowKey) {
    return state;
  }

  var orderByHistory = _without__default['default'](_toConsumableArray(sets[action.setKey].orderByHistory), action.windowKey);
...
var createBaseStore = function createBaseStore(specificStores) {
  var rootStores = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var middleware = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  var preloadedState = arguments.length > 3 ? arguments[3] : undefined;
  var enhancedThunk = thunk__default['default'].withExtraArgument(activeMetadataActions);
  var appliedMiddleware = redux.applyMiddleware.apply(void 0, [enhancedThunk].concat(_toConsumableArray(middleware)));

  if (process.env.NODE_ENV === 'development') {
    appliedMiddleware = redux.applyMiddleware.apply(void 0, [enhancedThunk, logger__default['default']].concat(_toConsumableArray(middleware)));
  }

  var stores = specificStores ? _objectSpread2(_objectSpread2(_objectSpread2({}, baseStores), rootStores), {}, {
    specific: redux.combineReducers(specificStores)
  }) : _objectSpread2(_objectSpread2({}, baseStores), rootStores);

  if (preloadedState) {
    return redux.createStore(redux.combineReducers(stores), preloadedState, redux.compose(reduxBatch.reduxBatch, appliedMiddleware, reduxBatch.reduxBatch));
  } else {
    return redux.createStore(redux.combineReducers(stores), redux.compose(reduxBatch.reduxBatch, appliedMiddleware, reduxBatch.reduxBatch));
  }
};
...
exports.activeMetadataActions = activeMetadataActions;
exports.baseStores = baseStores;
exports.commonActionTypes = commonActionTypes;
exports.commonActions = commonActions;
exports.commonHelpers = commonHelpers;
exports.commonReducers = commonReducers;
