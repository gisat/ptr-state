...
var _flattenDeep__default = /*#__PURE__*/_interopDefaultLegacy(_flattenDeep);
...
function isNaturalNumber(input) {
  return _isNumber__default['default'](input) && input > 0 && input % 1 === 0;
}
/**
...
var haveAllKeysRegisteredUse = function haveAllKeysRegisteredUse(getSubstate) {
  return createCachedSelector__default['default']([getUsedKeysForComponent(getSubstate), function (state, componentKey, keys) {
    ...
    if (usedKeys && keys !== null && keys !== void 0 && keys.length) {
      var notIncluded = _difference__default['default'](keys, usedKeys);
...
var getUsesWithActiveDependency = function getUsesWithActiveDependency(getSubstate) {
  ...
  function (indexedDataUses, activeKeys, filterByActive) {
    ...
    if (filterByActive && !_isEmpty2__default['default'](indexedDataUses)) {
      ...
      if (!_isEmpty2__default['default'](groupedUses)) {
        _map__default['default'](groupedUses, function (groupedUse) {
...
var getDataByDataSourceKeys = recompute.createSelector(function (dataSourceKeys) {
  if (dataSourceKeys) {
    ...
    _forEach__default['default'](dataSourceKeys, function (key) {
...
var getAttributesByDataSourceKeysForFeatureKey = recompute.createSelector(function (attributeDataSourceKeyAttributeKeyPairs, featureKey) {
  if (attributeDataSourceKeyAttributeKeyPairs && featureKey) {
    ...
    if (dataByDataSourceKey) {
      ...
      _forIn__default['default'](dataByDataSourceKey, function (dataSourceData, dataSourceKey) {
...
var isTileLoading = recompute.createSelector(function (filter, level, tile) {
  if (_isNumber__default['default'](level) && tile) {
            ...
            var _ret2 = function () {
              ...
              var _loop = function _loop(i) {
                ...
                if (featureKey) {
                  ...
                  _forIn__default['default'](attributeDsKeyAttributeKeyPairs, function (attributeKey, attributeDsKey) {
                    ...
                    if (value !== undefined) {
                      ...
                      if (finalFeaturesAsObject[i - start]) {
                        finalFeaturesAsObject[i - start].data[attributeKey] = value;
                          ...
                          value = isNaN(value) ? value : _isNumber__default['default'](value) ? value : Number(value); // TODO format?
...
var getIndexedFeatureKeys = recompute.createSelector(function (filter, level, tile, dataSourceKey) {
  if (_isNumber__default['default'](level) && tile && dataSourceKey) {
...
var getSpatialFilterByMapKey = createCachedSelector__default['default']([getViewByMapKey, function (state, mapKey, mapWidth) {
  return mapWidth;
...
var getByFullPeriodAsObject = createCachedSelector__default['default']([getAllAsObject$b, function (state, start) {
  return start;
...
function addLoadingIndex(pagination, filter, order) {
  ...
  var data = _reduce__default['default'](_toConsumableArray(Array(pagination.limit)), function (acc, val) {
...
function getRestPages(count, PAGE_SIZE) {
  ...
  optStart = _isNumber__default['default'](optStart) ? optStart : 1;

  if (_isNumber__default['default'](count) && (count === 0 || optStart > count)) {
    return [];
  } else {
    var wanted;

    if (_isNumber__default['default'](count)) {
      wanted = count - optStart + 1; // Request specific number of results

      if (_isNumber__default['default'](optLength)) {
...
function getPagination(pageIndex) {
  ...
  if (_isNumber__default['default'](optLength) && pageIndex * pageSize + pageSize > optLength) {
    limit = Math.max(0, optLength - pageIndex * pageSize);
  }

  if (_isNumber__default['default'](optCount) && optStart + pageIndex * pageSize + limit - 1 > optCount) {
...
function getLoadedPages() {
  ...
  pages.forEach(function (pageIndex) {
    ...
    if (_isNumber__default['default'](optCount)) {
      if (_isNumber__default['default'](optLength) && pageSize * (pageIndex + 1) > optLength) {
...
function getMissingPages(optDataIndex, pageSize, optStart, optLength) {
  ...
  var missingPages = _difference__default['default'](restPages, loadedPages);
  ...
  return function (dispatch, getState) {
    ...
    if (promises.length > 0) {
      return Promise.all(promises).then(function () {
        ...
        var spatialDataSourcesTypes = _flattenDeep__default['default'](response.map(function (r) {
...
function ensure$1(styleKey, commonRelationsFilter, spatialFilter, attributeDataFilterExtension) {
  return function (dispatch, getState) {
    ...
    if (!loadRelationsAndData && missingAttributesData) {
      ...
      var missingAttributeDataTilesToLoad = _difference__default['default'](missingAttributeDataTiles, missingSpatialDataTiles);

      var missingSpatialAndAttributeDataTiles = _intersection__default['default'](missingAttributeDataTiles, missingSpatialDataTiles);
...
function setLoading(attributeDataFilter, spatialIndex, spatialFilter, spatialRelationsFilter, order, loadGeometry) {
  return function (dispatch, getState) {
    ...
    var spatialTilesInNotLoadingState = _reduce__default['default'](loadingTilesGeometry, function () {
    ...
    var attributesTilesInNotLoadingState = _reduce__default['default'](loadingTilesGeometry, function () {
      var acc = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var tile = arguments.length > 1 ? arguments[1] : undefined;
...
function setMapViewport(mapKey, width, height) {
  return function (dispatch, getState) {
    if (mapKey && _isNumber__default['default'](width) && _isNumber__default['default'](height)) {
      var state = getState();
...
function ensureDependenciesOfActiveMetadataType(filterKey) {
  return function (dispatch) {
    ...
    _forIn__default['default'](STORES_TO_ENSURE_WITH_FILTER_BY_ACTIVE, function (params) {
...
var addWithIndex = function addWithIndex(state, index, data, filter, order, start, total, changedOn) {
  ...
  var newData = _reduce__default['default'](index, function (acc, val) {
    return [].concat(_toConsumableArray(acc), [{
      key: val
    }]);
  }, []);
...
var createBaseStore = function createBaseStore(specificStores, rootStores, middleware) {
  ...
  return redux.createStore(redux.combineReducers(stores), redux.compose(reduxBatch.reduxBatch, appliedMiddleware, reduxBatch.reduxBatch, redux.applyMiddleware(enhancedThunk), reduxBatch.reduxBatch));
};
