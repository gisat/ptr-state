...
import reducer from '../../../src/state/Views/reducers';

describe('state/Views/reducers', function () {
	describe('add', function () {
		const tests = [
			{
				name: 'no data',
				state: {byKey: null},
				action: {type: 'VIEWS.ADD'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty data',
				state: {byKey: null},
				action: {type: 'VIEWS.ADD', data: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some data',
		...
		const tests = [
			{
				name: 'no keys',
				state: {byKey: null},
				action: {type: 'VIEWS.ADD_UNRECEIVED'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty keys',
				state: {byKey: null},
				action: {type: 'VIEWS.ADD_UNRECEIVED', keys: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some keys',
				state: {byKey: null},
				action: {type: 'VIEWS.ADD_UNRECEIVED', keys: ['k1', 'k2']},
				expectedResult: {
					byKey: {
		...
		const tests = [
			{
				...
				action: {type: 'VIEWS.EDITED.REMOVE', keys: ['k1', 'k2']},
				expectedResult: {
					editedByKey: {k3: 3},
				},
			},
			{
				name: 'all',
				state: {editedByKey: {k1: 1, k2: 2, k3: 3}},
				action: {type: 'VIEWS.EDITED.REMOVE', keys: ['k1', 'k2', 'k3']},
				expectedResult: {
					editedByKey: {},
				},
			},
		...
		const tests = [
			{
				...
				action: {type: 'VIEWS.INDEX.CLEAR_ALL'},
				expectedResult: {
					indexes: null,
				},
			},
