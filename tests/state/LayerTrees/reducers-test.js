...
import reducer from '../../../src/state/LayerTrees/reducers';

describe('state/LayerTrees/reducers', function () {
	describe('add', function () {
		const tests = [
			{
				name: 'no data',
				state: {byKey: null},
				action: {type: 'LAYER_TREES.ADD'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty data',
				state: {byKey: null},
				action: {type: 'LAYER_TREES.ADD', data: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some data',
		...
		const tests = [
			{
				name: 'no keys',
				state: {byKey: null},
				action: {type: 'LAYER_TREES.ADD_UNRECEIVED'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty keys',
				state: {byKey: null},
				action: {type: 'LAYER_TREES.ADD_UNRECEIVED', keys: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some keys',
				state: {byKey: null},
				action: {
					type: 'LAYER_TREES.ADD_UNRECEIVED',
					keys: ['k1', 'k2'],
				},
				expectedResult: {
					byKey: {
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TREES.EDITED.REMOVE',
					keys: ['k1', 'k2'],
				},
				expectedResult: {
					editedByKey: {k3: 3},
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TREES.EDITED.UPDATE',
					data: [],
				},
				expectedResult: {
					editedByKey: {
		...
		const tests = [
			{
				...
				action: {type: 'LAYER_TREES.INDEX.CLEAR_ALL'},
				expectedResult: {
					indexes: null,
				},
			},
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TREES.USE.INDEXED.CLEAR',
					componentId: 'some2',
				},
				expectedResult: {
					inUse: {indexes: {some: 'some', some3: 'some3'}},
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TREES.USE.KEYS.CLEAR',
					componentId: 'comp2',
				},
				expectedResult: {
					inUse: {keys: {comp: ['k1', 'k3', 'k2']}},
