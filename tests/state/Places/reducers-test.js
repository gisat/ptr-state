...
import reducer from '../../../src/state/Places/reducers';

describe('state/Places/reducers', function () {
	describe('add', function () {
		const tests = [
			{
				name: 'no data',
				state: {byKey: null},
				action: {type: 'PLACES.ADD'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty data',
				state: {byKey: null},
				action: {type: 'PLACES.ADD', data: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some data',
		...
		const tests = [
			{
				name: 'no keys',
				state: {byKey: null},
				action: {type: 'PLACES.ADD_UNRECEIVED'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty keys',
				state: {byKey: null},
				action: {type: 'PLACES.ADD_UNRECEIVED', keys: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some keys',
				state: {byKey: null},
				action: {type: 'PLACES.ADD_UNRECEIVED', keys: ['k1', 'k2']},
				expectedResult: {
					byKey: {
		...
		const tests = [
			{
				...
				action: {
					type: 'PLACES.EDITED.REMOVE_PROPERTY',
					key: 'k2',
					property: 'p',
				},
				expectedResult: {
		...
		const tests = [
			{
				...
				action: {type: 'PLACES.INDEX.CLEAR_ALL'},
				expectedResult: {
					indexes: null,
				},
			},
		...
		const tests = [
			{
				...
				action: {
					type: 'PLACES.USE.INDEXED.REGISTER',
					componentId: 'compId',
					filterByActive: 'fba',
					filter: 'f',
					order: 'asc',
