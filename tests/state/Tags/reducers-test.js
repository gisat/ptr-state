...
import reducer from '../../../src/state/Tags/reducers';

describe('state/Tags/reducers', function () {
	describe('add', function () {
		const tests = [
			{
				name: 'no data',
				state: {byKey: null},
				action: {type: 'TAGS.ADD'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty data',
				state: {byKey: null},
				action: {type: 'TAGS.ADD', data: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some data',
		...
		const tests = [
			{
				name: 'no keys',
				state: {byKey: null},
				action: {type: 'TAGS.ADD_UNRECEIVED'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty keys',
				state: {byKey: null},
				action: {type: 'TAGS.ADD_UNRECEIVED', keys: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some keys',
				state: {byKey: null},
				action: {type: 'TAGS.ADD_UNRECEIVED', keys: ['k1', 'k2']},
				expectedResult: {
					byKey: {
		...
		const tests = [
			{
				...
				action: {type: 'TAGS.DELETE', keys: ['k1', 'k2']},
				expectedResult: {
					byKey: {k3: 3},
				},
			},
			{
				name: 'all',
				state: {byKey: {k1: 1, k2: 2, k3: 3}},
				action: {type: 'TAGS.DELETE', keys: ['k1', 'k2', 'k3']},
				expectedResult: {
					byKey: {},
				},
			},
		...
		const tests = [
			{
				...
				action: {type: 'TAGS.EDITED.UPDATE', data: []},
				expectedResult: {
					editedByKey: {
						k1: {data: {p: 1, ep: 2}},
						k2: {data: {p: 2}},
		...
		const tests = [
			{
				...
				action: {type: 'TAGS.INDEX.CLEAR_ALL'},
				expectedResult: {
					indexes: null,
				},
			},
		...
		const tests = [
			{
				...
				action: {type: 'TAGS.MARK_DELETED', key: 'sk'},
				expectedResult: {
					byKey: {nk: {v: 1}, nk2: {v: 2}},
				},
			},
		...
		const tests = [
			{
				...
				action: {type: 'TAGS.USE.INDEXED.CLEAR', componentId: 'some2'},
				expectedResult: {
					inUse: {indexes: {some: 'some', some3: 'some3'}},
				},
			},
			{
				...
				action: {type: 'TAGS.USE.INDEXED.CLEAR', componentId: 'some3'},
				expectedResult: {
