...
import reducer from '../../../src/state/LayerTemplates/reducers';

describe('state/LayerTemplates/reducers', function () {
	describe('add', function () {
		const tests = [
			{
				name: 'no data',
				state: {byKey: null},
				action: {type: 'LAYER_TEMPLATES.ADD'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty data',
				state: {byKey: null},
				action: {type: 'LAYER_TEMPLATES.ADD', data: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some data',
		...
		const tests = [
			{
				name: 'no keys',
				state: {byKey: null},
				action: {type: 'LAYER_TEMPLATES.ADD_UNRECEIVED'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty keys',
				state: {byKey: null},
				action: {type: 'LAYER_TEMPLATES.ADD_UNRECEIVED', keys: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some keys',
				state: {byKey: null},
				action: {
					type: 'LAYER_TEMPLATES.ADD_UNRECEIVED',
					keys: ['k1', 'k2'],
				},
				expectedResult: {
					byKey: {
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.EDITED.REMOVE',
					keys: ['k1', 'k2'],
				},
				expectedResult: {
					editedByKey: {k3: 3},
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.EDITED.REMOVE_PROPERTY',
					key: 'k2',
					property: 'p',
				},
				expectedResult: {
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.EDITED.UPDATE',
					data: [],
				},
				expectedResult: {
					editedByKey: {
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.INDEX.ADD',
					filter: 'fil',
					order: 'asc',
					changedOn: 'some time',
					count: 2,
		...
		const tests = [
			{
				...
				action: {type: 'LAYER_TEMPLATES.INDEX.CLEAR_ALL'},
				expectedResult: {
					indexes: null,
				},
			},
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.INDEX.CLEAR_INDEX',
					filter: 'fil2',
					order: 'asc',
				},
				expectedResult: {
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.MARK_DELETED',
					key: 'sk',
				},
				expectedResult: {
					byKey: {nk: {v: 1}, nk2: {v: 2}},
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.SET_ACTIVE_KEY',
					key: 'ak',
				},
				expectedResult: {
					activeKey: 'ak',
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.SET_ACTIVE_KEYS',
					keys: ['aks1', 'aks2'],
				},
				expectedResult: {
					activeKey: null,
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.USE.KEYS.REGISTER',
					componentId: 'comp',
					keys: ['k1', 'k2'],
				},
				expectedResult: {
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.USE.INDEXED.REGISTER',
					componentId: 'compId',
					filterByActive: 'fba',
					filter: 'f',
					order: 'asc',
		...
		const tests = [
			{
				...
				action: {
					type: 'LAYER_TEMPLATES.USE.INDEXED.CLEAR',
					componentId: 'some2',
				},
				expectedResult: {
					inUse: {indexes: {some: 'some', some3: 'some3'}},
