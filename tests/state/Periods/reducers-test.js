...
import reducer from '../../../src/state/Periods/reducers';

describe('state/Periods/reducers', function () {
	describe('add', function () {
		const tests = [
			{
				name: 'no data',
				state: {byKey: null},
				action: {type: 'PERIODS.ADD'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty data',
				state: {byKey: null},
				action: {type: 'PERIODS.ADD', data: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some data',
		...
		const tests = [
			{
				name: 'no keys',
				state: {byKey: null},
				action: {type: 'PERIODS.ADD_UNRECEIVED'},
				expectedResult: {byKey: {}},
			},
			{
				name: 'empty keys',
				state: {byKey: null},
				action: {type: 'PERIODS.ADD_UNRECEIVED', keys: []},
				expectedResult: {byKey: {}},
			},
			{
				name: 'some keys',
				state: {byKey: null},
				action: {type: 'PERIODS.ADD_UNRECEIVED', keys: ['k1', 'k2']},
				expectedResult: {
					byKey: {
		...
		const tests = [
			{
				...
				action: {type: 'PERIODS.INDEX.CLEAR_ALL'},
				expectedResult: {
					indexes: null,
				},
			},
		...
		const tests = [
			{
				...
				action: {
					type: 'PERIODS.USE.INDEXED.CLEAR',
					componentId: 'some2',
				},
				expectedResult: {
					inUse: {indexes: {some: 'some', some3: 'some3'}},
