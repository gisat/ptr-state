import reducers, {
	INITIAL_STATE,
} from '../../../../src/state/AttributeSets/reducers';
...
describe('add', () => {
	add.forEach(test => {
		const action = {...test.action, type: ActionTypes.ATTRIBUTE_SETS.ADD};
...
describe('addIndex', () => {
	addIndex.forEach(test => {
		const action = {...test.action, type: ActionTypes.ATTRIBUTE_SETS.INDEX.ADD};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('addUnreceivedKeys', () => {
	addUnreceivedKeys.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.ADD_UNRECEIVED,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('clearIndex', () => {
	clearIndex.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.INDEX.CLEAR_INDEX,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('clearIndexes', () => {
	clearIndexes.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.INDEX.CLEAR_ALL,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('markDeleted', () => {
	markDeleted.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.MARK_DELETED,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('registerUseIndexed', () => {
	registerUseIndexed.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.USE.INDEXED.REGISTER,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('remove', () => {
	remove.forEach(test => {
		const action = {...test.action, type: ActionTypes.ATTRIBUTE_SETS.DELETE};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('removeEdited', () => {
	removeEdited.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.EDITED.REMOVE,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('removeEditedActive', () => {
	removeEditedActive.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.EDITED.REMOVE_ACTIVE,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('removeEditedProperty', () => {
	removeEditedProperty.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.EDITED.REMOVE_PROPERTY,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('setActive', () => {
	setActive.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.SET_ACTIVE_KEY,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('updateEdited', () => {
	updateEdited.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.EDITED.UPDATE,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('updateStore', () => {
	updateStore.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.UPDATE_STORE,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('useIndexedClear', () => {
	useIndexedClear.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.USE.INDEXED.CLEAR,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('useIndexedClearAll', () => {
	useIndexedClearAll.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.USE.INDEXED.CLEAR_ALL,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('useKeysRegister', () => {
	useKeysRegister.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.USE.KEYS.REGISTER,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
...
describe('useKeysClear', () => {
	useKeysClear.forEach(test => {
		const action = {
			...test.action,
			type: ActionTypes.ATTRIBUTE_SETS.USE.KEYS.CLEAR,
		};
		it(test.name, () => test.test(action, reducers));
	});
});
