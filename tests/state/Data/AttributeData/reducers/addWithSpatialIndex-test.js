...
describe('addWithSpatialIndex-test', function () {
	...
	it('Should add data with spatial index to existing data source & spatial index', function () {
		const expectedState = {
			...state,
			byDataSourceKey: {
				...state.byDataSourceKey,
			...
			spatialIndexes: [
				{
					...
					index: {
						7: {
							'2.8125, 50.625': {
								dataSourceKey1: ['feature1', 'feature7'],
							},
						},
					},
				},
		...
		const action = {
			...
			order: null,
			attributeDataSourceKey: 'dataSourceKey1',
			changedOn: null,
		};
