...
describe('state/selections/selectors', function () {
	...
	describe('getAllAsObjectWithStyles', function () {
		...
		it('should return selections with styles', () => {
			...
			assert.deepEqual(
				Select.selections.getAllAsObjectWithStyles(state),
				result
			);
		});
		...
		it('should return original selections', () => {
			...
			assert.deepEqual(
				Select.selections.getAllAsObjectWithStyles(noStyleState),
				result
			);
			assert.deepEqual(
				Select.selections.getAllAsObjectWithStyles(noMatchStyleState),
				result
			);
			assert.deepEqual(
				Select.selections.getAllAsObjectWithStyles(emptyStyleState),
				result
			);
		});
