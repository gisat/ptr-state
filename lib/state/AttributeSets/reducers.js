...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].ATTRIBUTE_SETS.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.ADD_UNRECEIVED:
      return _reducers["default"].addUnreceivedKeys(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.DELETE:
      return _reducers["default"].remove(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.EDITED.REMOVE:
      return _reducers["default"].removeEdited(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.EDITED.REMOVE_ACTIVE:
      return _reducers["default"].removeEditedActive(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.EDITED.REMOVE_PROPERTY:
      return _reducers["default"].removeEditedProperty(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.EDITED.UPDATE:
      return _reducers["default"].updateEdited(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.INDEX.ADD:
      return _reducers["default"].addIndex(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.INDEX.CLEAR_ALL:
      return _reducers["default"].clearIndexes(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.INDEX.CLEAR_INDEX:
      return _reducers["default"].clearIndex(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.MARK_DELETED:
      return _reducers["default"].markDeleted(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.SET_ACTIVE_KEY:
      return _reducers["default"].setActive(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.SET_ACTIVE_KEYS:
      return _reducers["default"].setActiveMultiple(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.UPDATE_STORE:
      return _reducers["default"].updateStore(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.USE.INDEXED.CLEAR:
      return _reducers["default"].useIndexedClear(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.USE.INDEXED.CLEAR_ALL:
      return _reducers["default"].useIndexedClearAll(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.USE.INDEXED.REGISTER:
      return _reducers["default"].registerUseIndexed(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.USE.KEYS.REGISTER:
      return _reducers["default"].useKeysRegister(state, action);

    case _ActionTypes["default"].ATTRIBUTE_SETS.USE.KEYS.CLEAR:
