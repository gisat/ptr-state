...
var _selectors2 = _interopRequireDefault(require("../Data/selectors"));

var _selectors3 = _interopRequireDefault(require("../Selections/selectors"));

var _selectors4 = _interopRequireDefault(require("../Styles/selectors"));
...
var getSpatialFilterByMapKey = (0, _reReselect["default"])([getViewByMapKey, function (state, mapKey, mapWidth) {
  return mapWidth;
...
var getFinalLayerByDataSourceAndLayerState = (0, _recompute.createSelector)(function (spatialDataSource, layerState, layerKey, attributeDataSourceKeyAttributeKeyPairs, mapKey, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter) {
  ...
  if (type === 'wmts') {
    ...
    options = {
      params: _objectSpread(_objectSpread(_objectSpread({}, params), styles && {
        styles: styles
      }), {}, {
        layers: rest.layers
      }),
    ...
    if (type === 'vector') {
      features = _selectors2["default"].getFeatures(spatialDataSource.key, fidColumnName, attributeDataSourceKeyAttributeKeyPairs);
      ...
      tiles = _selectors2["default"].getTiles(spatialDataSource.key, fidColumnName, level, tileList, spatialRelationsFilter, attributeRelationsFilter, attributeDataSourceKeyAttributeKeyPairs, styleKey, attributeDataFilter);
    }
    ...
    if ((_options2 = options) !== null && _options2 !== void 0 && _options2.selected) {
      selected = _selectors3["default"].prepareSelectionByLayerStateSelected(options.selected);
    }

    if (!style && styleKey) {
      style = _selectors4["default"].getDefinitionByKey(styleKey);
    }
...
var getMapBackgroundLayer = (0, _recompute.createSelector)(function (mapKey, layerState) {
  ...
  if (layerState) {
    if (layerState.type) {
      ...
      var spatialDataSources = _selectors2["default"].spatialDataSources.getIndexed_recompute(layerState);
    ...
    (0, _lodash.forEach)(layersState, function (layerState) {
      ...
      if (layerState.type) {
        ...
        if (layerState.type === 'vector' && (_layerState$options4 = layerState.options) !== null && _layerState$options4 !== void 0 && _layerState$options4.selected) {
          layerState = _objectSpread(_objectSpread({}, layerState), {}, {
            options: _objectSpread(_objectSpread({}, layerState.options), {}, {
              selected: _selectors3["default"].prepareSelectionByLayerStateSelected(layerState.options.selected)
            })
          });
        }
        ...
        finalLayers.push(layerState);
          ...
          var spatialDataSources = _selectors2["default"].spatialDataSources.getIndexed_recompute(spatialRelationsFilter);

          var attributeDataSourceKeyAttributeKeyPairs = _selectors2["default"].attributeRelations.getFilteredAttributeDataSourceKeyAttributeKeyPairs(attributeRelationsFilter);
