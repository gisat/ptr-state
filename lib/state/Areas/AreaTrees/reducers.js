...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].AREAS.AREA_TREES.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.ADD_UNRECEIVED:
      return _reducers["default"].addUnreceivedKeys(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.INDEX.ADD:
      return _reducers["default"].addIndex(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.SET_ACTIVE_KEY:
      return _reducers["default"].setActive(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.USE.INDEXED.REGISTER:
      return _reducers["default"].registerUseIndexed(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.USE.INDEXED.CLEAR:
      return _reducers["default"].useIndexedClear(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.USE.KEYS.REGISTER:
      return _reducers["default"].useKeysRegister(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.USE.KEYS.CLEAR:
      return _reducers["default"].useKeysClear(state, action);

    case _ActionTypes["default"].AREAS.AREA_TREES.INDEX.CLEAR_ALL:
