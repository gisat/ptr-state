...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].SPATIAL_DATA_SOURCES.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].SPATIAL_DATA_SOURCES.ADD_UNRECEIVED:
      return _reducers["default"].addUnreceivedKeys(state, action);

    case _ActionTypes["default"].SPATIAL_DATA_SOURCES.USE.KEYS.REGISTER:
      return _reducers["default"].useKeysRegister(state, action);

    case _ActionTypes["default"].SPATIAL_DATA_SOURCES.USE.KEYS.CLEAR:
