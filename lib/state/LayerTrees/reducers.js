...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].LAYER_TREES.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].LAYER_TREES.ADD_UNRECEIVED:
      return _reducers["default"].addUnreceivedKeys(state, action);

    case _ActionTypes["default"].LAYER_TREES.DELETE:
      return _reducers["default"].remove(state, action);

    case _ActionTypes["default"].LAYER_TREES.EDITED.REMOVE:
      return _reducers["default"].removeEdited(state, action);

    case _ActionTypes["default"].LAYER_TREES.EDITED.REMOVE_PROPERTY:
      return _reducers["default"].removeEditedProperty(state, action);

    case _ActionTypes["default"].LAYER_TREES.EDITED.UPDATE:
      return _reducers["default"].updateEdited(state, action);

    case _ActionTypes["default"].LAYER_TREES.INDEX.ADD:
      return _reducers["default"].addIndex(state, action);

    case _ActionTypes["default"].LAYER_TREES.INDEX.CLEAR_ALL:
      return _reducers["default"].clearIndexes(state, action);

    case _ActionTypes["default"].LAYER_TREES.INDEX.CLEAR_INDEX:
      return _reducers["default"].clearIndex(state, action);

    case _ActionTypes["default"].LAYER_TREES.MARK_DELETED:
      return _reducers["default"].markDeleted(state, action);

    case _ActionTypes["default"].LAYER_TREES.UPDATE_STORE:
      return _reducers["default"].updateStore(state, action);

    case _ActionTypes["default"].LAYER_TREES.USE.KEYS.CLEAR:
      return _reducers["default"].useKeysClear(state, action);

    case _ActionTypes["default"].LAYER_TREES.USE.KEYS.REGISTER:
      return _reducers["default"].useKeysRegister(state, action);

    case _ActionTypes["default"].LAYER_TREES.USE.INDEXED.REGISTER:
      return _reducers["default"].registerUseIndexed(state, action);

    case _ActionTypes["default"].LAYER_TREES.USE.INDEXED.CLEAR:
      return _reducers["default"].useIndexedClear(state, action);

    case _ActionTypes["default"].LAYER_TREES.USE.INDEXED.CLEAR_ALL:
