  ...
  return function (dispatch, getState) {
    ...
    if (promises.length > 0) {
      return Promise.all(promises).then(function () {
        ...
        var spatialDataSourcesTypes = (0, _lodash.flattenDeep)(response.map(function (r) {
        ...
        var allSourcesAreUnsupported = !(0, _lodash.isEmpty)(spatialDataSourcesPairs) ? spatialDataSourcesPairs.every(function (ds) {
...
function loadMissingAttributeData(spatialFilter, styleKey, order, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter) {
  return function (dispatch, getState) {
    ...
    var loadAttributeRelationsAndDS = !(!(0, _lodash.isEmpty)(attributeRelations) && !(0, _lodash.isEmpty)(attributeDataSources)); //load only attribute data
...
function ensureDataAndRelations(spatialFilter, styleKey, order, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter) {
  return function (dispatch, getState) {
    ...
    if (spatialFilter && !(0, _lodash.isEmpty)(spatialFilter)) {
      // Only if spatialIndex is null then is set whole spatialFilter.tiles as loading true in one step
      var spatialIndex = null;
...
function ensure(styleKey, commonRelationsFilter, spatialFilter, attributeDataFilterExtension) {
  return function (dispatch, getState) {
    ...
    if (!loadRelationsAndData && missingAttributesData) {
      ...
      var missingSpatialDataTiles = (0, _helpers.getMissingTiles)(spatialDataIndex, spatialFilter) || [];
      var missingAttributeDataTilesToLoad = (0, _lodash.difference)(missingAttributeDataTiles, missingSpatialDataTiles);
      var missingSpatialAndAttributeDataTiles = (0, _lodash.intersection)(missingAttributeDataTiles, missingSpatialDataTiles);
    ...
    if (filterHasSpatialOrAreaRelations && missingSpatialData && !(0, _lodash.isEmpty)(modifiedSpatialFilterForSpatial.tiles)) {
    ...
    if (!loadRelationsAndData && !(0, _lodash.isEmpty)(modifiedSpatialFilterForAttributes.tiles)) {
...
function processResult(result, loadGeometry, loadAttributeRelations, loadSpatialRelations, order, spatialRelationsFilter, attributeRelationsFilter, attributeDataFilter, start) {
  return function (dispatch, getState) {
    ...
    // Attributes
    ////
    if (!!loadAttributeRelations && result.spatialAttributeRelationsDataSources.attributeRelations && !(0, _lodash.isEmpty)(result.spatialAttributeRelationsDataSources.attributeRelations)) {
      var changes = null;
    ...
    if (!!loadAttributeRelations && result.spatialAttributeRelationsDataSources.attributeDataSources && !(0, _lodash.isEmpty)(result.spatialAttributeRelationsDataSources.attributeDataSources)) {
      var _changes = null;
    ...
    if (result.spatialData && result.attributeData) {
      ...
      var spatialIndexData = _actions3["default"].getIndexDataBySpatialData(result.spatialData, result.attributeData);

      dispatch(_actions3["default"].receiveIndexedWithSpatialIndex(result.attributeData, spatialIndexData, attributeDataFilter, order, _changes2));
    } ////
    // Spatial data
    ////


    if (!!loadSpatialRelations && result.spatialAttributeRelationsDataSources.spatialRelations && !(0, _lodash.isEmpty)(result.spatialAttributeRelationsDataSources.spatialRelations)) {
      var _changes3 = null;
    ...
    if (!!loadSpatialRelations && result.spatialAttributeRelationsDataSources.spatialDataSources && !(0, _lodash.isEmpty)(result.spatialAttributeRelationsDataSources.spatialDataSources)) {
      var _changes4 = null;
...
function setLoading(attributeDataFilter, spatialIndex, spatialFilter, spatialRelationsFilter, order, loadGeometry) {
  return function (dispatch, getState) {
    ...
    var spatialTilesInNotLoadingState = (0, _lodash.reduce)(loadingTilesGeometry, function () {
    ...
    var attributesTilesInNotLoadingState = (0, _lodash.reduce)(loadingTilesGeometry, function () {
      var acc = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var tile = arguments.length > 1 ? arguments[1] : undefined;
