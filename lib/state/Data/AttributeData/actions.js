...
var receiveIndexedWithSpatialIndex = function receiveIndexedWithSpatialIndex(attributeData, spatialIndexData, attributeDataFilter, order, changedOn) {
  return function (dispatch) {
    if (!(0, _lodash.isEmpty)(attributeData)) {
...
var receiveIndexed = function receiveIndexed(attributeData, attributeDataFilter, order, start, total, changedOn) {
...
function addLoadingIndex(pagination, attributeDataFilter, order) {
  ...
  return actionAddIndex(attributeDataFilter, order, data, pagination.offset + 1, null, changedOn);
} // ============ helpers ============
  ...
  for (var _i2 = 0, _Object$entries = Object.entries(spatialData); _i2 < _Object$entries.length; _i2++) {
    ...
    for (var _i3 = 0, _Object$entries2 = Object.entries(datasource.spatialIndex); _i3 < _Object$entries2.length; _i3++) {
      ...
      for (var _i4 = 0, _Object$entries3 = Object.entries(tiles); _i4 < _Object$entries3.length; _i4++) {
        ...
        if (!indexByLevelByTileByDataSourceKey[level][(0, _helpers.tileAsString)(tile)] || (0, _lodash.isEmpty)(attributeData)) {
...
function actionAddIndex(attributeDataFilter, order, data, start, count, changedOn) {
  return {
