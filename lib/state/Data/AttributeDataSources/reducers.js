...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].DATA.ATTRIBUTE_DATA_SOURCES.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].DATA.ATTRIBUTE_DATA_SOURCES.INDEX.ADD:
      return _reducers["default"].addIndex(state, action);

    case _ActionTypes["default"].DATA.ATTRIBUTE_DATA_SOURCES.UPDATE_STORE:
