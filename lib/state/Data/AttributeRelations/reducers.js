...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].DATA.ATTRIBUTE_RELATIONS.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].DATA.ATTRIBUTE_RELATIONS.INDEX.ADD:
      return _reducers["default"].addIndex(state, action);

    case _ActionTypes["default"].DATA.ATTRIBUTE_RELATIONS.UPDATE_STORE:
