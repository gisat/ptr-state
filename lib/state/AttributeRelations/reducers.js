...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].ATTRIBUTE_RELATIONS.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].ATTRIBUTE_RELATIONS.ADD_UNRECEIVED:
      return _reducers["default"].addUnreceivedKeys(state, action);

    case _ActionTypes["default"].ATTRIBUTE_RELATIONS.INDEX.ADD:
      return _reducers["default"].addIndex(state, action);

    case _ActionTypes["default"].ATTRIBUTE_RELATIONS.USE.INDEXED.REGISTER:
      return _reducers["default"].registerUseIndexed(state, action);

    case _ActionTypes["default"].ATTRIBUTE_RELATIONS.USE.INDEXED.CLEAR:
      return _reducers["default"].useIndexedClear(state, action);

    case _ActionTypes["default"].ATTRIBUTE_RELATIONS.USE.INDEXED.CLEAR_ALL:
