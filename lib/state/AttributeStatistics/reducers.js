...
var _default = function _default() {
  ...
  switch (action.type) {
    case _ActionTypes["default"].ATTRIBUTE_STATISTICS.ADD:
      return _reducers["default"].add(state, action);

    case _ActionTypes["default"].ATTRIBUTE_STATISTICS.ADD_BATCH:
      return _reducers["default"].addBatch(state, action);

    case _ActionTypes["default"].ATTRIBUTE_STATISTICS.ADD_UNRECEIVED:
      return _reducers["default"].addUnreceivedKeys(state, action);

    case _ActionTypes["default"].ATTRIBUTE_STATISTICS.INDEX.ADD:
      return _reducers["default"].addIndex(state, action);

    case _ActionTypes["default"].ATTRIBUTE_STATISTICS.INDEX.ADD_BATCH:
      return _reducers["default"].addBatchIndex(state, action);

    case _ActionTypes["default"].ATTRIBUTE_STATISTICS.USE.INDEXED.REGISTER:
      return _reducers["default"].registerUseIndexed(state, action);

    case _ActionTypes["default"].ATTRIBUTE_STATISTICS.USE.INDEXED_BATCH.REGISTER:
      return _reducers["default"].registerBatchUseIndexed(state, action);

    case _ActionTypes["default"].ATTRIBUTE_DATA_SOURCES.USE.INDEXED.CLEAR:
