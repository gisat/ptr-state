...
var createBaseStore = function createBaseStore(specificStores) {
  ...
  if (preloadedState) {
    return (0, _redux.createStore)((0, _redux.combineReducers)(stores), preloadedState, (0, _redux.compose)(_reduxBatch.reduxBatch, appliedMiddleware, _reduxBatch.reduxBatch));
  } else {
    return (0, _redux.createStore)((0, _redux.combineReducers)(stores), (0, _redux.compose)(_reduxBatch.reduxBatch, appliedMiddleware, _reduxBatch.reduxBatch));
  }
};
